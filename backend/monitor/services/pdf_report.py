"""Render searchable, token-driven DEML operational reports as PDF bytes."""
...
TOKEN_FILE: Final[Path] = Path(__file__).resolve().parents[2] / "static" / "viking-tokens.json"
...
def render_pdf_report(
  ...
  *,
  ...
  """Create a landscape DEML report with branded header, summary, table, and footer."""
