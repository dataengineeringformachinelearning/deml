...
var VikingUI = (() => {
      ...
      if ((t && typeof t == "object") || typeof t == "function")
        for (let n of _t(t))
          !Lt.call(e, n) &&
            ...
            U(e, n, {
              get: () => t[n],
              enumerable: !(r = Vt(t, n)) || r.enumerable,
            });
      return e;
    };
  ...
  var et = (e) => `${e}-${Math.random().toString(36).slice(2, 9)}`,
    l = (e) =>
      e
        ...
        .replaceAll("'", "&#39;"),
    it = () =>
      typeof navigator < "u" && /Mac|iPhone|iPad/i.test(navigator.platform)
        ? "\u2318"
        : "Ctrl",
    s = (e, t) => {
  ...
  var st = {
    ...
    lt = Object.fromEntries(
      Object.entries(st).map(([e, t]) => [e, `<path d="${t}"/>`]),
    );
  var Ot = {
...
`;
  var Dt = new Set([
    ...
    k = class extends HTMLElement {
      ...
      onRemove = () => {
        this.dispatchEvent(
          new CustomEvent("viking-removed", { bubbles: !0, composed: !0 }),
        );
      };
      render() {
        let t = this.tone;
    ...
    m = class extends HTMLElement {
      ...
      render() {
        let t = this.getAttribute("href"),
          ...
          o =
            this.getAttribute("aria-busy") === "true" || this.loading
              ? "true"
              : null;
        ((this.shadow.innerHTML = `
      <${r}
    ...
    b = class extends HTMLElement {
      ...
      onDismiss = () => {
        (this.setAttribute("hidden", ""),
          this.dispatchEvent(
            new CustomEvent("viking-close", { bubbles: !0, composed: !0 }),
          ));
      };
      render() {
  ...
  var x = class extends HTMLElement {
      ...
      onClear = () => {
        ((this.value = ""),
          this.input?.focus(),
          this.dispatchEvent(
            new CustomEvent("viking-cleared", { bubbles: !0, composed: !0 }),
          ),
          this.dispatchEvent(
  ...
  var y = class extends HTMLElement {
      ...
      syncOpen() {
        ...
        t && !this.dialogEl.open
          ? (N(this.dialogEl),
            queueMicrotask(() => {
              (
                this.shadow.querySelector(".viking-modal-close") ??
                this.dialogEl
              )?.focus();
            }))
      ...
      updateTitle() {
        ...
        (i && (i.textContent = t),
          this.dialogEl?.setAttribute("aria-label", t));
      }
      render() {
        let t = this.getAttribute("title") ?? "Dialog";
        ((this.shadow.innerHTML = `
    ...
    `),
          ...
          this.dialogEl?.addEventListener("keydown", (i) => {
            i.key === "Escape" &&
              this.dismissible &&
              (i.preventDefault(), this.closeModal());
          }));
      }
    },
    D = () => {
  ...
  var Gt = (e) => {
    ...
    w = class extends HTMLElement {
      ...
      attributeChangedCallback(t) {
        if (
          this.isConnected &&
          (t === "open" && this.syncOpen(),
          t === "items" || t === "placeholder")
        )
          if (t === "placeholder" && this.inputEl) {
            let i =
              this.getAttribute("placeholder") ??
              "Search documentation, dashboard, API\u2026";
            ((this.inputEl.placeholder = i),
              this.inputEl.setAttribute("aria-label", i));
    ...
    `),
          ...
          (this.resultsEl = this.shadow.querySelector(
            ".viking-search-results-host",
          )),
          this.shadow
  ...
  var ft = [
      ...
      },
      {
        ...
        links: [
          ...
          },
          {
            ...
            appHref:
              "https://dataengineeringformachinelearning.com/compliance/",
            marketingHref: "/compliance",
          },
          {
            label: "GDPR Compliance",
            appHref:
              "https://dataengineeringformachinelearning.com/privacy/#gdpr",
    ...
    wt = (e, t) =>
      yt(e) || e.startsWith("mailto:") || e.startsWith("/")
        ? e
        : P(t.marketing, e),
  ...
  var Yt = (e) => {
    ...
    Q = (e, t, i) => {
      ...
      if (
        ...
        let a =
          i?.docsOrigin ?? "https://ui.dataengineeringformachinelearning.com";
  ...
  var Mt = new Set(["app", "marketing", "backend", "docs"]),
    ...
    re = (e) => {
      ...
      return {
        ...
        marketing:
          e.getAttribute("marketing-url") ?? t.marketing ?? K.marketing,
    ...
    E = class extends HTMLElement {
      ...
      openPalette() {
        (this.ensurePalette(),
          this.loadItems().then(() => this.paletteEl?.openPalette()));
      }
      closePalette() {
      ...
      async loadItems(t = !1) {
        ...
        try {
          let a = await fetch("/assets/site-drakkar.json", {
            cache: "no-cache",
          });
          if (a.ok) {
            let o = await a.json();
        ...
        (this.paletteEl.setAttribute("items", JSON.stringify(n)),
          (this.itemsLoaded = !0));
      }
    },
    B = () => {
  ...
  var S = class extends HTMLElement {
    ...
    `),
      ...
      syncOptions() {
        ...
        (r ? (this.selectEl.value = r) : t && (this.selectEl.value = t),
          this.syncFormValue());
      }
    },
    G = () => {
