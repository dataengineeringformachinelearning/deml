...
`;var Se=new Set(["accent","secondary","success","warning","danger","info","muted","subtle"]),I=class extends v{static tag="viking-badge";static legacyTag="viking-badge-wc";static get observedAttributes(){return["tone","size","icon","removable"]}shadow;constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),u(this.shadow,Gt)}connectedCallback(){this.render()}attributeChangedCallback(){this.isConnected&&this.render()}get tone(){let t=this.getAttribute("tone")??"";return Se.has(t)?t:null}get size(){return this.getAttribute("size")==="sm"?"sm":null}get removable(){return this.hasAttribute("removable")&&this.getAttribute("removable")!=="false"}onRemove=()=>{this.dispatchEvent(new CustomEvent("viking-removed",{bubbles:!0,composed:!0}))};render(){let t=this.tone;t&&this.getAttribute("tone")!==t?this.setAttribute("tone",t):!t&&this.hasAttribute("tone")&&this.removeAttribute("tone");let i=this.size;i&&this.getAttribute("size")!==i?this.setAttribute("size",i):!i&&this.hasAttribute("size")&&this.removeAttribute("size");let r=this.getAttribute("icon")??(t?nt[t]:null),a=r?p(r,16):"";this.shadow.innerHTML=`
    ...
    `,this.control=this.shadow.querySelector(r)}},ot=()=>{d(B.tag,B)};var Ie=new Set(["accent","secondary","success","warning","danger","info","muted"]),M=class extends v{static tag="viking-callout";static legacyTag="viking-callout-wc";static get observedAttributes(){return["tone","heading","icon","dismissible","hidden"]}shadow;constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),u(this.shadow,Ft)}connectedCallback(){this.render()}attributeChangedCallback(){this.isConnected&&this.render()}get tone(){let t=this.getAttribute("tone")??"info";return Ie.has(t)?t:"info"}get dismissible(){return this.hasAttribute("dismissible")&&this.getAttribute("dismissible")!=="false"}onDismiss=()=>{this.setAttribute("hidden",""),this.dispatchEvent(new CustomEvent("viking-close",{bubbles:!0,composed:!0}))};render(){let t=this.getAttribute("heading")??"",i=this.getAttribute("icon")??nt[this.tone]??"info",r=p(i,22,"viking-callout-icon");this.shadow.innerHTML=`
...
`,vt=()=>{d($.tag,$),h($.legacyTag,$)};var Ne=new Set(["accent","secondary","success","warning","danger","info","muted"]),N=class extends v{static tag="viking-status-pill";static legacyTag="viking-status-pill-wc";static get observedAttributes(){return["tone","icon","href","target","compact","dot","removable","aria-label"]}shadow;constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),u(this.shadow,He)}connectedCallback(){this.render()}attributeChangedCallback(){this.isConnected&&this.render()}get tone(){let t=this.getAttribute("tone")??"muted";return Ne.has(t)?t:"muted"}get compact(){let t=this.getAttribute("compact");return t!==null&&t!=="false"}get removable(){let t=this.getAttribute("removable");return t!==null&&t!=="false"}get href(){return this.getAttribute("href")}get icon(){return this.getAttribute("icon")}get showDot(){let t=this.getAttribute("dot");return t!==null&&t!=="false"}onRemove=()=>{this.dispatchEvent(new CustomEvent("viking-pill-removed",{bubbles:!0,composed:!0}))};render(){let t=this.tone,i=this.compact?" status-pill--compact":"",r=this.icon?p(this.icon,14,"status-pill__icon"):"",a=this.showDot?'<span class="status-pill__dot" aria-hidden="true"></span>':"",n='<span class="status-pill__label" part="label"><slot></slot></span>',s=o(this.getAttribute("aria-label")??""),l=this.href,c=this.getAttribute("target"),g=l&&c==="_blank"?' rel="noopener noreferrer"':"";if(l){this.shadow.innerHTML=`
        <a
...
`,ht=()=>{d(N.tag,N),h(N.legacyTag,N)};var W=[{id:"blue-notes",label:"Blue Notes",icon:"file",appHref:"https://dataengineeringformachinelearning.com/blog/",marketingHref:"/blog/"},{id:"book",label:"Book",icon:"policy",appHref:"https://dataengineeringformachinelearning.com/book/",marketingHref:"/book"},{id:"dashboard",label:"Dashboard",icon:"home",appHref:"/dashboard",marketingHref:"/dashboard",requireAuth:!0,platform:!0},{id:"sites",label:"Sites",icon:"building",appHref:"/settings",marketingHref:"/settings",requireAuth:!0,platform:!0},{id:"account",label:"Account",icon:"user",appHref:"/account",marketingHref:"/account",requireAuth:!0,platform:!0}],pt=[{title:"Platforms",links:[{label:"DEML",appHref:"/",marketingHref:"https://deml.app/",platform:!0},{label:"FORJD",appHref:"https://forjd.co/",marketingHref:"https://forjd.co/",external:!0},{label:"Explore",appHref:"/explore",marketingHref:"/explore",platform:!0},{label:"Dashboard",appHref:"/dashboard",marketingHref:"/dashboard",platform:!0,requireAuth:!0}]},{title:"Resources",links:[{label:"Community",appHref:"https://dataengineeringformachinelearning.com/",marketingHref:"/"},{label:"Whitepaper",appHref:"https://dataengineeringformachinelearning.com/whitepaper/",marketingHref:"/whitepaper"},{label:"Book",appHref:"https://dataengineeringformachinelearning.com/book/",marketingHref:"/book"},{label:"Blue Notes",appHref:"https://dataengineeringformachinelearning.com/blog/",marketingHref:"/blog/"},{label:"DEML Swagger",appHref:"https://backend.deml.app/api/v1/docs",marketingHref:"https://backend.deml.app/api/v1/docs",external:!0},{label:"DEML ReDoc",appHref:"https://backend.deml.app/api/v1/redoc",marketingHref:"https://backend.deml.app/api/v1/redoc",external:!0},{label:"FORJD Swagger",appHref:"https://backend.forjd.co/docs",marketingHref:"https://backend.forjd.co/docs",external:!0},{label:"FORJD ReDoc",appHref:"https://backend.forjd.co/redoc",marketingHref:"https://backend.forjd.co/redoc",external:!0}]},{title:"Support",links:[{label:"Platform Status",appHref:"/status/platform-status",marketingHref:"/status/platform-status",platform:!0},{label:"Report a Bug",appHref:"#",marketingHref:"#",action:"bug-report"}]},{title:"Legal & Compliance",links:[{label:"Privacy Policy",appHref:"https://dataengineeringformachinelearning.com/privacy/",marketingHref:"/privacy"},{label:"Terms of Service",appHref:"https://dataengineeringformachinelearning.com/terms/",marketingHref:"/terms"},{label:"SOC2 Compliance",appHref:"https://dataengineeringformachinelearning.com/compliance/",marketingHref:"/compliance"},{label:"GDPR Compliance",appHref:"https://dataengineeringformachinelearning.com/privacy/#gdpr",marketingHref:"/privacy#gdpr"},{label:"Cookie Settings",appHref:"#",marketingHref:"#",action:"cookie-settings"}]}],Oe="reportBug=1",De="cookieSettings=1",Xt=e=>/^https?:\/\//i.test(e),ut=(e,t)=>{if(Xt(t))return t;let i=e.replace(/\/$/,""),r=t.startsWith("/")?t:`/${t}`;return`${i}${r}`},Tt=e=>`${ut(e.app,"/")}?${Oe}`,Vt=e=>`${ut(e.marketing,"/")}?${De}`,Qt=(e,t,i)=>Xt(e)||e.startsWith("mailto:")||t==="marketing"&&e.startsWith("/")?e:ut(i.marketing,e),Zt=(e,t,i)=>t==="app"?e:ut(i.app,e),U=(e,t,i)=>e.platform?Zt(e.appHref,t,i):t==="app"?e.appHref:Qt(e.marketingHref,t,i),kt=(e,t,i)=>e.action==="bug-report"?t==="app"?"#":Tt(i):e.action==="cookie-settings"?Vt(i):e.platform?Zt(e.appHref,t,i):t==="app"?e.appHref:Qt(e.marketingHref,t,i),mt=(e,t)=>e==="marketing"?"/":t.marketing,te=(e,t=!1)=>e.filter(i=>!i.requireAuth||t);var y={app:"https://deml.app",marketing:"https://dataengineeringformachinelearning.com",backend:"https://backend.deml.app"};var ee=e=>{if(e==null)return!1;let t=e.trim().toLowerCase();return t===""||t==="true"||t==="1"?!0:!(t==="false"||t==="0"||t==="off"||t==="no")},bt=(e,t=0)=>{if(e==null||e.trim()==="")return t;let i=Number(e);return Number.isFinite(i)?i:t},ie=e=>{if(!(e==null||e.trim()===""))try{return JSON.parse(e)}catch{return}},ft=(e,t,i)=>{let r=i??t[0];if(r===void 0)throw new Error("parseSelect requires a non-empty options list");return e==null?r:t.includes(e)?e:r};var G=class extends v{_props={};_updateScheduled=!1;connectedCallback(){this.scheduleRender()}attributeChangedCallback(t,i,r){i!==r&&this.isConnected&&this.scheduleRender()}attr(t,i){let r=this.getAttribute(t);return i?.parser?r==null&&i.default!==void 0?i.default:i.parser(r):r??(i?.default!==void 0?String(i.default):null)}setProp(t,i){Object.is(this._props[t],i)||(this._props[t]=i,this.isConnected&&this.scheduleRender())}getProp(t){return this._props[t]}requestUpdate(){this.scheduleRender()}scheduleRender(){this._updateScheduled||(this._updateScheduled=!0,queueMicrotask(()=>{this._updateScheduled=!1,this.isConnected&&this.render()}))}};var ne=["app","marketing","backend","docs"],re=()=>{if(typeof document>"u")return"marketing";let e=document.documentElement.getAttribute("data-deml-context");if(e&&ne.includes(e))return e;if(typeof window>"u")return"marketing";let t=window.location.hostname;return t.startsWith("backend.")?"backend":t.startsWith("ui.")?"docs":t.includes("deml.app")?"app":"marketing"},H=class extends G{static tag="viking-site-footer";static legacyTag="viking-site-footer-wc";static get observedAttributes(){return["context","app-url","marketing-url","backend-url","year","authenticated"]}onAuthState=t=>{let i=t.detail;this.toggleAttribute("authenticated",i?.isAuthenticated===!0)};connectedCallback(){window.addEventListener("deml:auth-state",this.onAuthState),document.documentElement.dataset.authenticated==="true"&&this.setAttribute("authenticated",""),super.connectedCallback()}disconnectedCallback(){window.removeEventListener("deml:auth-state",this.onAuthState)}resolveContext(){return this.attr("context",{parser:t=>ft(t,ne,re()),default:re()})}resolveUrls(){let t=globalThis.__DEML??{};return{app:this.getAttribute("app-url")??t.app??y.app,marketing:this.getAttribute("marketing-url")??t.marketing??y.marketing,backend:this.getAttribute("backend-url")??t.backend??y.backend}}resolveYear(){return this.attr("year",{parser:t=>bt(t,new Date().getFullYear()),default:new Date().getFullYear()})}render(){let t=this.resolveContext(),i=this.resolveUrls(),r=this.resolveYear(),a=this.hasAttribute("authenticated"),n=pt.map(s=>{let l=s.links.filter(c=>!c.requireAuth||a).map(c=>{let g=kt(c,t,i);return`
          <li>
            <a href="${o(g)}">${o(c.label)}</a>
          </li>
        `}).join("");return`
      <div class="footer-column">
        <h2 class="footer-column-title">${o(s.title)}</h2>
    ...
    `}},Q=()=>{d(H.tag,H),h(H.legacyTag,H)};Q();var ae=new Set(["app","marketing","backend","docs"]),Re=()=>{let e=document.documentElement.getAttribute("data-deml-context");if(e&&ae.has(e))return e;let t=window.location.hostname;return t.startsWith("ui.")?"docs":t.startsWith("backend.")?"backend":t.includes("deml.app")?"app":"marketing"},ze=e=>{let t=e.getAttribute("context");return t&&ae.has(t)?t:Re()},oe=(e,t)=>{let i=e.getAttribute(t);return i!==null&&i!=="false"},Pe=e=>{let t=globalThis.__DEML??{};return{app:e.getAttribute("app-url")??t.app??y.app,marketing:e.getAttribute("marketing-url")??t.marketing??y.marketing,backend:e.getAttribute("backend-url")??t.backend??y.backend}},Ke=e=>oe(e,"authenticated"),Be=e=>e.getAttribute("show-search")===null?!0:oe(e,"show-search"),qe=(e,t)=>{let i=e.getAttribute("sign-in-href");if(i)return i;let r=e.getAttribute("return-url")??window.location.href;return`${t.app}/login?returnUrl=${encodeURIComponent(r)}`},z=(e,t,i={})=>{let r=i.id?` id="${o(i.id)}"`:"",a=i.color?` data-viking-icon-color="${o(i.color)}"`:"",n=i.className?` class="${o(i.className)}"`:"";return`<span${r}${n} data-viking-icon="${o(e)}" data-viking-icon-size="${t}"${a} aria-hidden="true">${p(e,t,"viking-navbar-inline-icon")}</span>`},O=class extends HTMLElement{static tag="viking-site-navbar";static legacyTag="viking-site-navbar-wc";static get observedAttributes(){return["context","app-url","marketing-url","backend-url","authenticated","show-search","sign-in-href","dashboard-href","return-url"]}mobileMenuOpen=!1;connectedCallback(){this.render(),this.addEventListener("click",this.onHostClick),document.addEventListener("click",this.onDocumentClick),document.addEventListener("keydown",this.onDocumentKeydown),window.addEventListener("resize",this.onWindowResize)}disconnectedCallback(){this.removeEventListener("click",this.onHostClick),document.removeEventListener("click",this.onDocumentClick),document.removeEventListener("keydown",this.onDocumentKeydown),window.removeEventListener("resize",this.onWindowResize)}attributeChangedCallback(){this.isConnected&&this.render()}renderNavLinks(t,i,r="desktop"){let a=r==="mobile"?"mobile-nav-btn":"nav-btn";return W.map(n=>{let s=U(n,t,i),l=n.requireAuth,c=l?" hidden":"",g=l?' data-require-auth="true"':"";return`
        <a
          href="${o(s)}"
          class="${a}"
          data-nav-id="${o(n.id)}"
    ...
    `:""}render(){let t=ze(this),i=Pe(this),r=Ke(this),a=Be(this),n=mt(t,i),s=qe(this,i),l=this.getAttribute("dashboard-href")??`${i.app}/dashboard`,c=this.renderNavLinks(t,i,"desktop"),g=this.renderNavLinks(t,i,"mobile"),m=this.renderAuthDesktop(r,s,l),f=this.renderAuthMobile(r,l,s),b=this.renderSearchButton(a);this.innerHTML=`
      <header class="navbar">
    ...
    `,this.syncMobileMenu()}onHostClick=t=>{let i=typeof t.composedPath=="function"?t.composedPath():[];if(i.some(n=>n instanceof HTMLElement&&n.id==="mobile-menu-btn")){t.preventDefault(),this.toggleMobileMenu();return}i.some(n=>n instanceof HTMLElement&&n.closest?.("#mobile-menu")&&(n.matches("a")||n.matches("viking-button-wc")))&&this.closeMobileMenu()};onDocumentClick=t=>{if(!this.mobileMenuOpen)return;let i=t.target;i instanceof Node&&!this.contains(i)&&this.closeMobileMenu()};onDocumentKeydown=t=>{t.key==="Escape"&&this.closeMobileMenu()};onWindowResize=()=>{window.matchMedia("(min-width: 768px)").matches&&this.closeMobileMenu()};toggleMobileMenu(){this.mobileMenuOpen=!this.mobileMenuOpen,this.syncMobileMenu()}closeMobileMenu(){this.mobileMenuOpen&&(this.mobileMenuOpen=!1,this.syncMobileMenu())}syncMobileMenu(){let t=this.querySelector("#mobile-menu"),i=this.querySelector("#mobile-menu-btn");!t||!i||(t.classList.toggle("open",this.mobileMenuOpen),t.toggleAttribute("hidden",!this.mobileMenuOpen),i.setAttribute("aria-expanded",this.mobileMenuOpen?"true":"false"),i.setAttribute("aria-label",this.mobileMenuOpen?"Close navigation menu":"Toggle navigation menu"),i.innerHTML=z(this.mobileMenuOpen?"x":"menu",24))}},yt=()=>{d(O.tag,O),h(O.legacyTag,O)};var We=e=>{let t=new Set;return e.filter(i=>{let r=`${i.title}:${i.href}:${i.action??""}`;return t.has(r)?!1:(t.add(r),!0)})},Ue=(e,t,i)=>({title:e.label,href:U(e,t,i),snippet:`Open ${e.label}`,group:"Platform",keywords:[e.id,e.label.toLowerCase(),"navigate","go"]}),Ge=(e,t,i,r)=>e.action==="cookie-settings"?{title:e.label,href:Vt(r),snippet:"Manage analytics and cookie preferences",group:t,keywords:["cookies","consent","privacy","gdpr"],action:"cookie-settings"}:e.action==="bug-report"?{title:e.label,href:i==="app"?"#":Tt(r),snippet:"Submit a product issue or regression",group:t,keywords:["bug","issue","support","feedback"],action:"bug-report"}:{title:e.label,href:kt(e,i,r),snippet:`Open ${e.label}`,group:t,keywords:[e.label.toLowerCase(),t.toLowerCase()]},Fe=[{title:"Viking-UI Storybook",snippet:"Hosted Storybook for Viking-UI primitives",group:"Resources",keywords:["viking","ui","design system","components","storybook"]},{title:"DEML product showcase",snippet:"Operational intelligence product home on deml.app",group:"Resources",keywords:["deml","product","showcase","docs","quick start"]},{title:"DEML Swagger",snippet:"Interactive DEML control-plane OpenAPI",group:"Resources",keywords:["api","openapi","swagger","rest","deml"]},{title:"DEML ReDoc",snippet:"Readable DEML control-plane API reference",group:"Resources",keywords:["api","openapi","redoc","rest","deml"]},{title:"FORJD Swagger",snippet:"Interactive FORJD data-plane OpenAPI",group:"Resources",keywords:["api","openapi","swagger","forjd","streaming"]},{title:"FORJD ReDoc",snippet:"Readable FORJD data-plane API reference",group:"Resources",keywords:["api","openapi","redoc","forjd","streaming"]}],je=(e,t,i)=>{switch(e.title){case"Viking-UI Storybook":return"https://ui.deml.app/";case"DEML product showcase":return`${i.app.replace(/\/$/,"")}/#docs`;case"DEML Swagger":return`${i.backend.replace(/\/$/,"")}/api/v1/docs`;case"DEML ReDoc":return`${i.backend.replace(/\/$/,"")}/api/v1/redoc`;case"FORJD Swagger":return"https://backend.forjd.co/docs";case"FORJD ReDoc":return"https://backend.forjd.co/redoc";default:return t==="app"?i.app:i.marketing}},Ye=[{title:"Storybook home",href:"/",snippet:"Browse Viking-UI stories",group:"Viking-UI",keywords:["storybook","components","showcase","registry"]}],Je=(e,t)=>e.startsWith("http")?e:`${t.replace(/\/$/,"")}${e.startsWith("/")?e:`/${e}`}`,$t=(e,t,i)=>{let r=i?.authenticated??e==="app",a=[...W.filter(n=>!n.requireAuth||r).map(n=>Ue(n,e,t)),...pt.flatMap(n=>n.links.filter(s=>!s.requireAuth||r).map(s=>Ge(s,n.title,e,t))),...Fe.map(n=>({...n,href:je(n,e,t)}))];if(e==="app"&&(a.push({title:"Explore status pages",href:"/explore",snippet:"Public status directory",group:"App",keywords:["explore","status","directory","public"]},{title:"Platform status",href:"/status/platform-status",snippet:"Live public sentinel for the DEML stack",group:"App",keywords:["platform-status","tenant0","health","sla"]},{title:"Login",href:"/login",snippet:"Sign in or complete SMS MFA",group:"App",keywords:["login","sign in","auth","mfa"]}),r&&a.push({title:"Dashboard",href:"/dashboard",snippet:"CES overview, KPIs, and performance telemetry",group:"App",keywords:["dashboard","ces","home","overview","kpi"]},{title:"Analytics",href:"/analytics",snippet:"Latency, origins, threat charts, and gauges",group:"App",keywords:["analytics","charts","latency","map","threat"]},{title:"Status pages",href:"/status",snippet:"Your published and draft status surfaces",group:"App",keywords:["status","pages","uptime","incidents"]},{title:"Vulnerabilities",href:"/vulnerabilities",snippet:"SOC triage and vulnerability Kanban",group:"App",keywords:["vulnerabilities","soc","semgrep","trivy","kanban"]},{title:"Account",href:"/account",snippet:"Profile, MFA enrollment, and linked accounts",group:"App",keywords:["account","profile","mfa","oauth"]},{title:"Settings",href:"/settings",snippet:"Workspace domains, billing, and security",group:"App",keywords:["settings","sites","workspace","configuration"]},{title:"Billing & subscription",href:"/settings/billing",snippet:"Manage plan, invoices, and payment methods",group:"App",keywords:["billing","stripe","subscription","payment"]},{title:"Security settings",href:"/settings/security",snippet:"Keys, sessions, and access controls",group:"App",keywords:["security","keys","auth","rbac"]})),e==="backend"&&a.push({title:"OpenAPI / Swagger",href:`${t.backend.replace(/\/$/,"")}/api/v1/docs`,snippet:"Interactive DEML control-plane sandbox",group:"Backend",keywords:["swagger","openapi","docs","api"]},{title:"ReDoc",href:`${t.backend.replace(/\/$/,"")}/api/v1/redoc`,snippet:"Readable DEML control-plane reference",group:"Backend",keywords:["redoc","openapi","docs","api"]}),e==="docs"){let n=i?.docsOrigin??"https://ui.deml.app";a.push(...Ye.map(s=>({...s,href:Je(s.href,n)})))}return We(a)};var se=["dataengineeringformachinelearning_com_zjafyosh2v_pages","deml_app_pages","deml_backend_pages","DEML UI"],Xe={dataengineeringformachinelearning_com_zjafyosh2v_pages:"https://dataengineeringformachinelearning.com",deml_app_pages:"https://deml.app",deml_backend_pages:"https://backend.deml.app","DEML UI":"https://ui.deml.app"},Qe=()=>typeof globalThis>"u"?{}:globalThis.ALGOLIA_CONFIG??{},w=e=>typeof e=="string"&&e.trim()?e:null,Z=e=>{let t=w(e);return t&&/^https?:\/\//i.test(t)?t:null},Ze=(e,t)=>{let i=w(e.objectID),r=Z(e.url)||Z(e.url_without_anchor)||Z(e.permalink)||Z(e.link)||Z(i);if(r)return r;let a=w(e.path);if(!a)return null;let n=w(e.hostname),s=Xe[t]||(n?`https://${n.replace(/^https?:\/\//i,"")}`:null);if(!s)return null;try{return new URL(a.startsWith("/")?a:`/${a}`,s).href}catch{return null}},ti=(e,t)=>{let i=Ze(e,t);if(!i)return null;let r=e.hierarchy,a=w(e.title)||w(r?.lvl1)||w(r?.lvl0)||w(e.path)||i,n=w(e.description)||(w(e.content)??"").slice(0,160)||w(r?.lvl2)||"",s=w(e.hostname);if(!s)try{s=new URL(i).hostname}catch{s=t}let l=w(e.keywords),c=w(e.path)??"";return{title:a.slice(0,120),href:i,snippet:n?`${s} \xB7 ${n.slice(0,140)}`:s,group:"Live pages",keywords:[s,t,c,...l?l.split(/[,\s]+/).filter(Boolean):[]].filter(Boolean)}},xt=async(e,t)=>{let i=e.trim();if(!i||i.length<2)return[];let r=Qe(),a=r.appId||"ZJAFYOSH2V",n=r.apiKey||"";if(!n)return[];let s=r.indexNames&&r.indexNames.length>0?r.indexNames:[...se],l=t?.hitsPerPage??8,c=`https://${a}-dsn.algolia.net/1/indexes/*/queries`;try{let g=await fetch(c,{method:"POST",headers:{"Content-Type":"application/json","X-Algolia-Application-Id":a,"X-Algolia-API-Key":n},body:JSON.stringify({requests:s.map(x=>({indexName:x,params:new URLSearchParams({query:i,hitsPerPage:String(l),attributesToRetrieve:["url","url_without_anchor","permalink","link","title","description","content","path","hostname","keywords","hierarchy","type","objectID"].join(","),attributesToHighlight:"[]"}).toString()}))}),signal:t?.signal});if(!g.ok)return[];let m=await g.json(),f=new Set,b=[];return(m.results??[]).forEach((x,A)=>{let Et=x.index||s[A]||"pages";(x.hits??[]).forEach(At=>{let R=ti(At,Et);!R||f.has(R.href)||(f.add(R.href),b.push(R))})}),b}catch{return[]}},le=se;var de=new Set(["app","marketing","backend","docs"]),ei=()=>{let e=document.documentElement.getAttribute("data-deml-context");if(e&&de.has(e))return e;let t=window.location.hostname;return t.startsWith("ui.")?"docs":t.includes("deml.app")&&!t.startsWith("backend.")?"app":t.startsWith("backend.")?"backend":"marketing"},ii=e=>{let t=globalThis.__DEML??{};return{app:e.getAttribute("app-url")??t.app??y.app,marketing:e.getAttribute("marketing-url")??t.marketing??y.marketing,backend:e.getAttribute("backend-url")??t.backend??y.backend}},ri=e=>{let t=e.getAttribute("context");return t&&de.has(t)?t:ei()},ce=e=>e.hasAttribute("authenticated")||document.documentElement.dataset.authenticated==="true",S=class extends v{static tag="viking-suite-command-palette";static searchTag="viking-suite-search-palette";static legacyTag="viking-suite-search-palette-wc";static get observedAttributes(){return["context","app-url","marketing-url","backend-url","placeholder","global-shortcut","authenticated"]}paletteEl=null;itemsLoaded=!1;curatedItems=[];queryTimer=null;searchAbort=null;onAuthState=t=>{let i=t.detail;this.toggleAttribute("authenticated",i?.isAuthenticated===!0)};onPaletteQuery=t=>{let r=t.detail?.query??"";this.scheduleAlgoliaSearch(r)};connectedCallback(){q(),window.addEventListener("deml:auth-state",this.onAuthState),this.ensurePalette(),this.loadItems()}disconnectedCallback(){window.removeEventListener("deml:auth-state",this.onAuthState),this.paletteEl?.removeEventListener("viking-query",this.onPaletteQuery),this.queryTimer&&(clearTimeout(this.queryTimer),this.queryTimer=null),this.searchAbort?.abort()}attributeChangedCallback(t){if(this.isConnected){if(t==="placeholder"&&this.paletteEl){let i=this.getAttribute("placeholder")??"Search documentation, dashboard, settings\u2026";this.paletteEl.setAttribute("placeholder",i);return}if(t==="global-shortcut"&&this.paletteEl){k(this,"global-shortcut")||!this.hasAttribute("global-shortcut")?this.paletteEl.setAttribute("global-shortcut",""):this.paletteEl.removeAttribute("global-shortcut");return}(t==="context"||t==="app-url"||t==="marketing-url"||t==="backend-url"||t==="authenticated")&&this.loadItems(!0)}}openPalette(){this.ensurePalette(),this.loadItems().then(()=>this.paletteEl?.openPalette())}closePalette(){this.paletteEl?.closePalette()}ensurePalette(){if(this.paletteEl)return;this.paletteEl=document.createElement("viking-command-palette"),this.paletteEl.id="deml-command-palette";let t=this.getAttribute("placeholder")??"Search documentation, dashboard, settings\u2026";this.paletteEl.setAttribute("placeholder",t),(k(this,"global-shortcut")||!this.hasAttribute("global-shortcut"))&&this.paletteEl.setAttribute("global-shortcut",""),this.paletteEl.addEventListener("viking-query",this.onPaletteQuery),this.append(this.paletteEl)}scheduleAlgoliaSearch(t){this.queryTimer&&clearTimeout(this.queryTimer),this.queryTimer=setTimeout(()=>{this.mergeAlgoliaResults(t)},180)}async mergeAlgoliaResults(t){if(!this.paletteEl)return;this.itemsLoaded||await this.loadItems();let i=t.trim();if(i.length<2){this.paletteEl.setAttribute("items",JSON.stringify(this.curatedItems));return}this.searchAbort?.abort(),this.searchAbort=new AbortController;let r=await xt(i,{hitsPerPage:6,signal:this.searchAbort.signal}),a=this.curatedItems,n=new Set(a.map(l=>l.href.replace(/\/$/,""))),s=r.filter(l=>{let c=l.href.replace(/\/$/,"");return n.has(c)?!1:(n.add(c),!0)}).map(l=>({...l,keywords:[...l.keywords??[],i,l.title,l.href]}));this.paletteEl.setAttribute("items",JSON.stringify([...a,...s]))}async loadItems(t=!1){if(!this.paletteEl||this.itemsLoaded&&!t)return;let i=ri(this),r=ii(this),a=i==="docs"?window.location.origin:"https://ui.deml.app",n=$t(i,r,{docsOrigin:a,authenticated:ce(this)});try{(await fetch("/assets/site-drakkar.json",{cache:"no-cache"}).catch(()=>null)||await fetch("/site-drakkar.json",{cache:"no-cache"}).catch(()=>null))?.ok&&(n=$t(i,r,{docsOrigin:a,authenticated:ce(this)}))}catch{}this.curatedItems=n,this.paletteEl.setAttribute("items",JSON.stringify(n)),this.itemsLoaded=!0}},F=()=>{d(S.tag,S),h(S.searchTag,S),h(S.legacyTag,S)};var ge=`
:host {
  display: inline-flex;
}
...
`,ni=e=>{document.documentElement.setAttribute("data-theme",e),document.documentElement.classList.toggle("dark",e==="dark"),localStorage.setItem("theme",e)},ve=()=>{let e=localStorage.getItem("theme");return e==="light"||e==="dark"?e:window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"},j=class extends v{static tag="viking-theme-toggle-wc";shadow;button=null;sunIcon=null;moonIcon=null;onStorage=()=>{this.syncIcons()};constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),u(this.shadow,ge)}connectedCallback(){this.setAttribute("role","button"),this.render(),this.syncIcons(),this.button?.addEventListener("click",this.onClick),window.addEventListener("storage",this.onStorage),window.addEventListener("viking-theme-change",this.onThemeChange)}disconnectedCallback(){this.button?.removeEventListener("click",this.onClick),window.removeEventListener("storage",this.onStorage),window.removeEventListener("viking-theme-change",this.onThemeChange)}onThemeChange=()=>{this.syncIcons()};onClick=()=>{let t=ve()==="light"?"dark":"light";ni(t),this.syncIcons(),this.dispatchEvent(new CustomEvent("viking-theme-change",{bubbles:!0,composed:!0,detail:{theme:t}}))};syncIcons=()=>{let t=ve()==="dark";this.sunIcon?.classList.toggle("is-visible",t),this.moonIcon?.classList.toggle("is-visible",!t)};render(){let t=this.getAttribute("aria-label")??"Toggle light and dark theme";this.shadow.innerHTML=`
    ...
    `,u(this.shadow,ge),this.button=this.shadow.querySelector("button"),this.sunIcon=this.shadow.querySelector(".theme-icon-sun"),this.moonIcon=this.shadow.querySelector(".theme-icon-moon")}},Y=()=>{d(j.tag,j)};var he=new Set(["app","marketing","backend","docs"]),ai=`
:host {
  display: block;
  position: sticky;
  top: 0;
