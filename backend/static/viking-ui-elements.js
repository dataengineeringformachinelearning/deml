...
`,ht=()=>{d(N.tag,N),h(N.legacyTag,N)};var W=[{id:"blue-notes",label:"Blue Notes",icon:"file",appHref:"https://dataengineeringformachinelearning.com/blog/",marketingHref:"/blog/"},{id:"book",label:"Book",icon:"policy",appHref:"https://dataengineeringformachinelearning.com/book/",marketingHref:"/book"},{id:"dashboard",label:"Dashboard",icon:"home",appHref:"/dashboard",marketingHref:"/dashboard",requireAuth:!0,platform:!0},{id:"sites",label:"Sites",icon:"building",appHref:"/settings",marketingHref:"/settings",requireAuth:!0,platform:!0},{id:"account",label:"Account",icon:"user",appHref:"/account",marketingHref:"/account",requireAuth:!0,platform:!0}],ut=[{title:"Platforms",links:[{label:"DEML",appHref:"/",marketingHref:"https://deml.app/",platform:!0},{label:"FORJD",appHref:"https://forjd.co/",marketingHref:"https://forjd.co/",external:!0},{label:"Explore",appHref:"/explore",marketingHref:"/explore",platform:!0},{label:"Dashboard",appHref:"/dashboard",marketingHref:"/dashboard",platform:!0,requireAuth:!0}]},{title:"Resources",links:[{label:"Community",appHref:"https://dataengineeringformachinelearning.com/",marketingHref:"/"},{label:"Whitepaper",appHref:"https://dataengineeringformachinelearning.com/whitepaper/",marketingHref:"/whitepaper"},{label:"Book",appHref:"https://dataengineeringformachinelearning.com/book/",marketingHref:"/book"},{label:"Blue Notes",appHref:"https://dataengineeringformachinelearning.com/blog/",marketingHref:"/blog/"},{label:"DEML Swagger",appHref:"https://backend.deml.app/api/v1/docs",marketingHref:"https://backend.deml.app/api/v1/docs",external:!0},{label:"DEML ReDoc",appHref:"https://backend.deml.app/api/v1/redoc",marketingHref:"https://backend.deml.app/api/v1/redoc",external:!0},{label:"FORJD capabilities",appHref:"https://backend.forjd.co/api/v1/capabilities",marketingHref:"https://backend.forjd.co/api/v1/capabilities",external:!0}]},{title:"Support",links:[{label:"Platform Status",appHref:"/status/platform-status",marketingHref:"/status/platform-status",platform:!0},{label:"Report a Bug",appHref:"#",marketingHref:"#",action:"bug-report"}]},{title:"Legal & Compliance",links:[{label:"Privacy Policy",appHref:"https://dataengineeringformachinelearning.com/privacy/",marketingHref:"/privacy"},{label:"Terms of Service",appHref:"https://dataengineeringformachinelearning.com/terms/",marketingHref:"/terms"},{label:"SOC2 Compliance",appHref:"https://dataengineeringformachinelearning.com/compliance/",marketingHref:"/compliance"},{label:"GDPR Compliance",appHref:"https://dataengineeringformachinelearning.com/privacy/#gdpr",marketingHref:"/privacy#gdpr"},{label:"Cookie Settings",appHref:"#",marketingHref:"#",action:"cookie-settings"}]}],Oe="reportBug=1",De="cookieSettings=1",Xt=e=>/^https?:\/\//i.test(e),pt=(e,t)=>{if(Xt(t))return t;let i=e.replace(/\/$/,""),r=t.startsWith("/")?t:`/${t}`;return`${i}${r}`},Tt=e=>`${pt(e.app,"/")}?${Oe}`,Vt=e=>`${pt(e.marketing,"/")}?${De}`,Qt=(e,t,i)=>Xt(e)||e.startsWith("mailto:")||t==="marketing"&&e.startsWith("/")?e:pt(i.marketing,e),Zt=(e,t,i)=>t==="app"?e:pt(i.app,e),G=(e,t,i)=>e.platform?Zt(e.appHref,t,i):t==="app"?e.appHref:Qt(e.marketingHref,t,i),kt=(e,t,i)=>e.action==="bug-report"?t==="app"?"#":Tt(i):e.action==="cookie-settings"?Vt(i):e.platform?Zt(e.appHref,t,i):t==="app"?e.appHref:Qt(e.marketingHref,t,i),mt=(e,t)=>e==="marketing"?"/":t.marketing,te=(e,t=!1)=>e.filter(i=>!i.requireAuth||t);var y={app:"https://deml.app",marketing:"https://dataengineeringformachinelearning.com",backend:"https://backend.deml.app"};var ee=e=>{if(e==null)return!1;let t=e.trim().toLowerCase();return t===""||t==="true"||t==="1"?!0:!(t==="false"||t==="0"||t==="off"||t==="no")},bt=(e,t=0)=>{if(e==null||e.trim()==="")return t;let i=Number(e);return Number.isFinite(i)?i:t},ie=e=>{if(!(e==null||e.trim()===""))try{return JSON.parse(e)}catch{return}},ft=(e,t,i)=>{let r=i??t[0];if(r===void 0)throw new Error("parseSelect requires a non-empty options list");return e==null?r:t.includes(e)?e:r};var U=class extends v{_props={};_updateScheduled=!1;connectedCallback(){this.scheduleRender()}attributeChangedCallback(t,i,r){i!==r&&this.isConnected&&this.scheduleRender()}attr(t,i){let r=this.getAttribute(t);return i?.parser?r==null&&i.default!==void 0?i.default:i.parser(r):r??(i?.default!==void 0?String(i.default):null)}setProp(t,i){Object.is(this._props[t],i)||(this._props[t]=i,this.isConnected&&this.scheduleRender())}getProp(t){return this._props[t]}requestUpdate(){this.scheduleRender()}scheduleRender(){this._updateScheduled||(this._updateScheduled=!0,queueMicrotask(()=>{this._updateScheduled=!1,this.isConnected&&this.render()}))}};var ne=["app","marketing","backend","docs"],re=()=>{if(typeof document>"u")return"marketing";let e=document.documentElement.getAttribute("data-deml-context");if(e&&ne.includes(e))return e;if(typeof window>"u")return"marketing";let t=window.location.hostname;return t.startsWith("backend.")?"backend":t.startsWith("ui.")?"docs":t.includes("deml.app")?"app":"marketing"},H=class extends U{static tag="viking-site-footer";static legacyTag="viking-site-footer-wc";static get observedAttributes(){return["context","app-url","marketing-url","backend-url","year","authenticated"]}onAuthState=t=>{let i=t.detail;this.toggleAttribute("authenticated",i?.isAuthenticated===!0)};connectedCallback(){window.addEventListener("deml:auth-state",this.onAuthState),document.documentElement.dataset.authenticated==="true"&&this.setAttribute("authenticated",""),super.connectedCallback()}disconnectedCallback(){window.removeEventListener("deml:auth-state",this.onAuthState)}resolveContext(){return this.attr("context",{parser:t=>ft(t,ne,re()),default:re()})}resolveUrls(){let t=globalThis.__DEML??{};return{app:this.getAttribute("app-url")??t.app??y.app,marketing:this.getAttribute("marketing-url")??t.marketing??y.marketing,backend:this.getAttribute("backend-url")??t.backend??y.backend}}resolveYear(){return this.attr("year",{parser:t=>bt(t,new Date().getFullYear()),default:new Date().getFullYear()})}render(){let t=this.resolveContext(),i=this.resolveUrls(),r=this.resolveYear(),a=this.hasAttribute("authenticated"),n=ut.map(s=>{let l=s.links.filter(c=>!c.requireAuth||a).map(c=>{let g=kt(c,t,i);return`
    ...
    `}},Q=()=>{d(H.tag,H),h(H.legacyTag,H)};Q();var ae=new Set(["app","marketing","backend","docs"]),ze=()=>{let e=document.documentElement.getAttribute("data-deml-context");if(e&&ae.has(e))return e;let t=window.location.hostname;return t.startsWith("ui.")?"docs":t.startsWith("backend.")?"backend":t.includes("deml.app")?"app":"marketing"},Re=e=>{let t=e.getAttribute("context");return t&&ae.has(t)?t:ze()},oe=(e,t)=>{let i=e.getAttribute(t);return i!==null&&i!=="false"},Pe=e=>{let t=globalThis.__DEML??{};return{app:e.getAttribute("app-url")??t.app??y.app,marketing:e.getAttribute("marketing-url")??t.marketing??y.marketing,backend:e.getAttribute("backend-url")??t.backend??y.backend}},Ke=e=>oe(e,"authenticated"),Be=e=>e.getAttribute("show-search")===null?!0:oe(e,"show-search"),qe=(e,t)=>{let i=e.getAttribute("sign-in-href");if(i)return i;let r=e.getAttribute("return-url")??window.location.href;return`${t.app}/login?returnUrl=${encodeURIComponent(r)}`},R=(e,t,i={})=>{let r=i.id?` id="${o(i.id)}"`:"",a=i.color?` data-viking-icon-color="${o(i.color)}"`:"",n=i.className?` class="${o(i.className)}"`:"";return`<span${r}${n} data-viking-icon="${o(e)}" data-viking-icon-size="${t}"${a} aria-hidden="true">${u(e,t,"viking-navbar-inline-icon")}</span>`},O=class extends HTMLElement{static tag="viking-site-navbar";static legacyTag="viking-site-navbar-wc";static get observedAttributes(){return["context","app-url","marketing-url","backend-url","authenticated","show-search","sign-in-href","dashboard-href","return-url"]}mobileMenuOpen=!1;connectedCallback(){this.render(),this.addEventListener("click",this.onHostClick),document.addEventListener("click",this.onDocumentClick),document.addEventListener("keydown",this.onDocumentKeydown),window.addEventListener("resize",this.onWindowResize)}disconnectedCallback(){this.removeEventListener("click",this.onHostClick),document.removeEventListener("click",this.onDocumentClick),document.removeEventListener("keydown",this.onDocumentKeydown),window.removeEventListener("resize",this.onWindowResize)}attributeChangedCallback(){this.isConnected&&this.render()}renderNavLinks(t,i,r="desktop"){let a=r==="mobile"?"mobile-nav-btn":"nav-btn";return W.map(n=>{let s=G(n,t,i),l=n.requireAuth,c=l?" hidden":"",g=l?' data-require-auth="true"':"";return`
      ...
      <div class="desktop-auth" role="group" aria-label="Account actions">
        <viking-button-wc
          ...
          id="auth-btn-desktop"
        >
          ${R(t?"home":"arrow-right",16,{id:"auth-icon-desktop"})}
    ...
    `}renderAuthMobile(t,i,r){return`
      ...
      <viking-button-wc
        ...
        id="auth-btn-mobile"
      >
        ${R(t?"home":"arrow-right",16,{id:"auth-icon-mobile"})}
    ...
    `:""}render(){let t=Re(this),i=Pe(this),r=Ke(this),a=Be(this),n=mt(t,i),s=qe(this,i),l=this.getAttribute("dashboard-href")??`${i.app}/dashboard`,c=this.renderNavLinks(t,i,"desktop"),g=this.renderNavLinks(t,i,"mobile"),m=this.renderAuthDesktop(r,s,l),f=this.renderAuthMobile(r,l,s),b=this.renderSearchButton(a);this.innerHTML=`
      <header class="navbar">
        <div class="navbar-content">
          <div class="navbar-left">
            <a href="${o(n)}" class="navbar-brand" aria-label="Go to homepage" id="navbar-brand-link">
              ${R("drakkar",28,{color:"accent",className:"brand-icon navbar-logo"})}
            </a>
          </div>
...
`,ii=e=>{document.documentElement.setAttribute("data-theme",e),document.documentElement.classList.toggle("dark",e==="dark"),localStorage.setItem("theme",e)},ve=()=>{let e=localStorage.getItem("theme");return e==="light"||e==="dark"?e:window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"},j=class extends v{static tag="viking-theme-toggle-wc";shadow;button=null;sunIcon=null;moonIcon=null;onStorage=()=>{this.syncIcons()};constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),p(this.shadow,ge)}connectedCallback(){this.setAttribute("role","button"),this.render(),this.syncIcons(),this.button?.addEventListener("click",this.onClick),window.addEventListener("storage",this.onStorage),window.addEventListener("viking-theme-change",this.onThemeChange)}disconnectedCallback(){this.button?.removeEventListener("click",this.onClick),window.removeEventListener("storage",this.onStorage),window.removeEventListener("viking-theme-change",this.onThemeChange)}onThemeChange=()=>{this.syncIcons()};onClick=()=>{let t=ve()==="light"?"dark":"light";ii(t),this.syncIcons(),this.dispatchEvent(new CustomEvent("viking-theme-change",{bubbles:!0,composed:!0,detail:{theme:t}}))};syncIcons=()=>{let t=ve()==="dark";this.sunIcon?.classList.toggle("is-visible",t),this.moonIcon?.classList.toggle("is-visible",!t)};render(){let t=this.getAttribute("aria-label")??"Toggle light and dark theme";this.shadow.innerHTML=`
    ...
    `,p(this.shadow,ge),this.button=this.shadow.querySelector("button"),this.sunIcon=this.shadow.querySelector(".theme-icon-sun"),this.moonIcon=this.shadow.querySelector(".theme-icon-moon")}},Y=()=>{d(j.tag,j)};var he=new Set(["app","marketing","backend","docs"]),ri=`
:host {
  display: block;
  position: sticky;
  top: 0;
...
`,ni=()=>{let e=document.documentElement.getAttribute("data-deml-context");if(e&&he.has(e))return e;let t=window.location.hostname;return t.startsWith("ui.")?"docs":t.startsWith("backend.")?"backend":t.includes("deml.app")?"app":"marketing"},ai=e=>{let t=e.getAttribute("context");return t&&he.has(t)?t:ni()},oi=e=>{let t=globalThis.__DEML??{};return{app:e.getAttribute("app-url")??t.app??y.app,marketing:e.getAttribute("marketing-url")??t.marketing??y.marketing,backend:e.getAttribute("backend-url")??t.backend??y.backend}},si=e=>{try{let t=new URL(e,window.location.origin);return t.origin===window.location.origin&&t.pathname===window.location.pathname}catch{return!1}},J=class extends v{static tag="viking-suite-header";static get observedAttributes(){return["context","app-url","marketing-url","backend-url","authenticated","user-name","user-email","sign-in-href","dashboard-href"]}shadow;menuOpen=!1;userMenuOpen=!1;paletteEl=null;constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),p(this.shadow,ri)}connectedCallback(){Y(),F(),this.render(),document.addEventListener("click",this.onDocumentClick)}disconnectedCallback(){document.removeEventListener("click",this.onDocumentClick)}attributeChangedCallback(){this.isConnected&&this.render()}openSearch(){this.paletteEl?.openPalette(),this.dispatchEvent(new CustomEvent("viking-search-open",{bubbles:!0,composed:!0}))}onDocumentClick=t=>{t.composedPath().includes(this)||(this.menuOpen||this.userMenuOpen)&&(this.menuOpen=!1,this.userMenuOpen=!1,this.syncOpenState())};onSearchClick=()=>{this.openSearch()};onMenuClick=()=>{this.menuOpen=!this.menuOpen,this.syncOpenState()};onUserClick=()=>{this.userMenuOpen=!this.userMenuOpen,this.syncOpenState()};onSignInClick=t=>{let i=new CustomEvent("viking-sign-in",{bubbles:!0,cancelable:!0,composed:!0,detail:t});this.dispatchEvent(i),i.defaultPrevented&&t.preventDefault()};onSignOutClick=()=>{this.userMenuOpen=!1,this.menuOpen=!1,this.syncOpenState(),this.dispatchEvent(new CustomEvent("viking-sign-out",{bubbles:!0,composed:!0}))};syncOpenState(){let t=this.shadow.querySelector(".suite-header"),i=this.shadow.querySelector("[data-menu-toggle]"),r=this.shadow.querySelector(".suite-header__user"),a=this.shadow.querySelector("[data-user-toggle]");t?.setAttribute("data-menu-open",String(this.menuOpen)),i?.setAttribute("aria-expanded",String(this.menuOpen)),r?.setAttribute("data-open",String(this.userMenuOpen)),a?.setAttribute("aria-expanded",String(this.userMenuOpen))}renderNavLinks(t,i,r){return te(W,r).map(a=>{let n=G(a,t,i),s=si(n)?' aria-current="page"':"";return`
    ...
    `}getDashboardHref(t){return this.getAttribute("dashboard-href")??`${t.app}/dashboard`}render(){let t=ai(this),i=oi(this),r=k(this,"authenticated"),a=this.renderNavLinks(t,i,r),n=mt(t,i),s=`${rt()}K`;this.shadow.innerHTML=`
