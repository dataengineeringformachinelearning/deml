...
`;var Qe=new Set(["accent","secondary","success","warning","danger","info","muted","subtle"]),w=class extends l{static tag="viking-badge";static legacyTag="viking-badge-wc";static get observedAttributes(){return["tone","size","icon","removable"]}shadow;constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),v(this.shadow,Ie)}connectedCallback(){this.render()}attributeChangedCallback(){this.isConnected&&this.render()}get tone(){let e=this.getAttribute("tone")??"";return Qe.has(e)?e:null}get size(){return this.getAttribute("size")==="sm"?"sm":null}get removable(){return this.hasAttribute("removable")&&this.getAttribute("removable")!=="false"}onRemove=()=>{this.dispatchEvent(new CustomEvent("viking-removed",{bubbles:!0,composed:!0}))};render(){let e=this.tone;e&&this.getAttribute("tone")!==e?this.setAttribute("tone",e):!e&&this.hasAttribute("tone")&&this.removeAttribute("tone");let i=this.size;i&&this.getAttribute("size")!==i?this.setAttribute("size",i):!i&&this.hasAttribute("size")&&this.removeAttribute("size");let n=this.getAttribute("icon")??(e?W[e]:null),r=n?g(n,16):"";this.shadow.innerHTML=`
    ...
    `,this.control=this.shadow.querySelector(n)}},j=()=>{c(E.tag,E),d(E.legacyTag,E)};var tt=new Set(["accent","secondary","success","warning","danger","info","muted"]),_=class extends l{static tag="viking-callout";static legacyTag="viking-callout-wc";static get observedAttributes(){return["tone","heading","icon","dismissible","hidden"]}shadow;constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),v(this.shadow,Me)}connectedCallback(){this.render()}attributeChangedCallback(){this.isConnected&&this.render()}get tone(){let e=this.getAttribute("tone")??"info";return tt.has(e)?e:"info"}get dismissible(){return this.hasAttribute("dismissible")&&this.getAttribute("dismissible")!=="false"}onDismiss=()=>{this.setAttribute("hidden",""),this.dispatchEvent(new CustomEvent("viking-close",{bubbles:!0,composed:!0}))};render(){let e=this.getAttribute("heading")??"",i=this.getAttribute("icon")??W[this.tone]??"info",n=g(i,22,"viking-callout-icon");this.shadow.innerHTML=`
    ...
    `,this.shadow.querySelector(".viking-callout-close")?.addEventListener("click",this.onDismiss)}},F=()=>{c(_.tag,_),d(_.legacyTag,_)};var S=class extends l{static tag="viking-card";static legacyTag="viking-card-wc";static get observedAttributes(){return["compact","interactive","title","loading"]}connectedCallback(){this.syncClasses()}attributeChangedCallback(){this.isConnected&&this.syncClasses()}syncClasses(){this.classList.add("viking-card"),this.classList.toggle("viking-card-compact",this.hasAttribute("compact")),this.classList.toggle("viking-card-interactive",this.hasAttribute("interactive")),this.classList.toggle("viking-card-loading",this.hasAttribute("loading"));let e=this.getAttribute("title");e?(this.setAttribute("role","region"),this.setAttribute("aria-label",e)):(this.removeAttribute("role"),this.removeAttribute("aria-label"))}},Y=()=>{c(S.tag,S),d(S.legacyTag,S)};var I=class extends l{static tag="viking-field";static legacyTag="viking-field-wc";static get observedAttributes(){return["label","description","error","required","width"]}shadow;labelId=x("viking-field-label");descriptionId=x("viking-field-description");errorId=x("viking-field-error");slotEl=null;constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),v(this.shadow,Se)}connectedCallback(){this.render(),this.syncControlA11y()}disconnectedCallback(){this.slotEl?.removeEventListener("slotchange",this.syncControlA11y)}attributeChangedCallback(){this.isConnected&&(this.render(),this.syncControlA11y())}get control(){return(this.slotEl?.assignedElements({flatten:!0})??[]).find(i=>i instanceof HTMLElement)??null}focusControl=()=>{this.control?.focus?.()};syncControlA11y=()=>{let e=this.control;if(!e)return;let i=[this.getAttribute("description")??"",this.getAttribute("error")??""].filter(Boolean).join(" "),n=this.getAttribute("label")??"";n&&!e.hasAttribute("aria-label")&&e.setAttribute("aria-label",n),i?e.setAttribute("aria-description",i):e.removeAttribute("aria-description"),this.getAttribute("error")?(e.setAttribute("aria-invalid","true"),e.setAttribute("error",this.getAttribute("error")??"")):(e.removeAttribute("aria-invalid"),e.getAttribute("error")===""&&e.removeAttribute("error")),h(this,"required")&&e.setAttribute("required","")};render(){let e=this.getAttribute("label")??"",i=this.getAttribute("description")??"",n=this.getAttribute("error")??"",r=h(this,"required");this.shadow.innerHTML=`
...
`,xt=()=>{let t=document.documentElement.getAttribute("data-deml-context");if(t&&Pe.has(t))return t;let e=window.location.hostname;return e.startsWith("ui.")?"docs":e.startsWith("backend.")?"backend":e.includes("deml.app")?"app":"marketing"},wt=t=>{let e=t.getAttribute("context");return e&&Pe.has(e)?e:xt()},Et=t=>{let e=globalThis.__DEML??{};return{app:t.getAttribute("app-url")??e.app??A.app,marketing:t.getAttribute("marketing-url")??e.marketing??A.marketing,backend:t.getAttribute("backend-url")??e.backend??A.backend}},_t=t=>{try{let e=new URL(t,window.location.origin);return e.origin===window.location.origin&&e.pathname===window.location.pathname}catch{return!1}},D=class extends l{static tag="viking-suite-header";static get observedAttributes(){return["context","app-url","marketing-url","backend-url","authenticated","user-name","user-email","sign-in-href","dashboard-href"]}shadow;menuOpen=!1;userMenuOpen=!1;paletteEl=null;constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),v(this.shadow,yt)}connectedCallback(){z(),$(),this.render(),document.addEventListener("click",this.onDocumentClick)}disconnectedCallback(){document.removeEventListener("click",this.onDocumentClick)}attributeChangedCallback(){this.isConnected&&this.render()}openSearch(){this.paletteEl?.openPalette(),this.dispatchEvent(new CustomEvent("viking-search-open",{bubbles:!0,composed:!0}))}onDocumentClick=e=>{e.composedPath().includes(this)||(this.menuOpen||this.userMenuOpen)&&(this.menuOpen=!1,this.userMenuOpen=!1,this.syncOpenState())};onSearchClick=()=>{this.openSearch()};onMenuClick=()=>{this.menuOpen=!this.menuOpen,this.syncOpenState()};onUserClick=()=>{this.userMenuOpen=!this.userMenuOpen,this.syncOpenState()};onSignInClick=e=>{let i=new CustomEvent("viking-sign-in",{bubbles:!0,cancelable:!0,composed:!0,detail:e});this.dispatchEvent(i),i.defaultPrevented&&e.preventDefault()};onSignOutClick=()=>{this.userMenuOpen=!1,this.menuOpen=!1,this.syncOpenState(),this.dispatchEvent(new CustomEvent("viking-sign-out",{bubbles:!0,composed:!0}))};syncOpenState(){let e=this.shadow.querySelector(".suite-header"),i=this.shadow.querySelector("[data-menu-toggle]"),n=this.shadow.querySelector(".suite-header__user"),r=this.shadow.querySelector("[data-user-toggle]");e?.setAttribute("data-menu-open",String(this.menuOpen)),i?.setAttribute("aria-expanded",String(this.menuOpen)),n?.setAttribute("data-open",String(this.userMenuOpen)),r?.setAttribute("aria-expanded",String(this.userMenuOpen))}renderNavLinks(e,i,n){return ze(J,n).map(r=>{let o=te(r,e,i),s=_t(o)?' aria-current="page"':"";return`
    ...
    `}getDashboardHref(e){return this.getAttribute("dashboard-href")??`${e.app}/dashboard`}render(){let e=wt(this),i=Et(this),n=h(this,"authenticated"),r=this.renderNavLinks(e,i,n),o=Oe(e,i),s=`${q()}K`;this.shadow.innerHTML=`
