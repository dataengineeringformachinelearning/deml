...
var VikingUI = (() => {
    ...
    Tt = (e, t, i, r) => {
      if ((t && typeof t == 'object') || typeof t == 'function')
        for (let n of _t(t))
          !Lt.call(e, n) &&
            n !== i &&
            U(e, n, { get: () => t[n], enumerable: !(r = Vt(t, n)) || r.enumerable });
      return e;
    };
  var Ht = e => Tt(U({}, '__esModule', { value: !0 }), e);
  var se = {};
  Nt(se, {
    VikingBadgeWc: () => k,
    VikingButtonWc: () => m,
    ...
    VikingInputWc: () => x,
    VikingModalWc: () => y,
    VikingSearchPaletteWc: () => w,
    VikingSelectWc: () => S,
    VikingSuiteSearchPaletteWc: () => E,
    VikingThemeToggleWc: () => M,
    registerVikingBadgeWc: () => H,
    registerVikingButtonWc: () => O,
    registerVikingCalloutWc: () => z,
    registerVikingCardWc: () => $,
    registerVikingElements: () => J,
    registerVikingInputWc: () => R,
    registerVikingModalWc: () => D,
    registerVikingSearchPaletteWc: () => I,
    registerVikingSelectWc: () => G,
    registerVikingSuiteSearchPaletteWc: () => B,
    registerVikingThemeToggleWc: () => W,
  });
  var c = (e, t) => {
    ...
    d = (e, t) => e.hasAttribute(t) && e.getAttribute(t) !== 'false',
    L = (e, t) => {
      typeof e.setFormValue == 'function' && e.setFormValue(t);
    },
    N = e => {
      e && typeof e.showModal == 'function' && !e.open && e.showModal();
    },
    p = e => {
      e && typeof e.close == 'function' && e.open && e.close();
    };
  var et = e => `${e}-${Math.random().toString(36).slice(2, 9)}`,
    l = e =>
      e
        .replaceAll('&', '&amp;')
        .replaceAll('<', '&lt;')
        ...
        .replaceAll("'", '&#39;'),
    it = () =>
      typeof navigator < 'u' && /Mac|iPhone|iPad/i.test(navigator.platform) ? '\u2318' : 'Ctrl',
    s = (e, t) => {
  ...
  var st = {
    ...
    u = e => {
      let t = ot[e],
        i = st[e];
      return `<path fill="${t}" d="${i}"/>`;
    },
    ue = {
      kubernetes: u('kubernetes'),
      tensorflow: u('tensorflow'),
      pytorch: u('pytorch'),
      'apache-spark': u('apache-spark'),
      databricks: u('databricks'),
      'aws-redshift': u('aws-redshift'),
    },
    lt = Object.fromEntries(Object.entries(st).map(([e, t]) => [e, `<path d="${t}"/>`]));
  var Ot = {
    ...
    dt = ['play', 'dots-horizontal', 'dots-vertical', 'grip-vertical'],
    we = ['google', 'apple', ...at];
  var $t = new Set(Object.keys(C)),
    gt = e => {
    ...
    Ee = Object.keys(F);
  var Rt = new Set(dt),
    h = (e, t = 16, i = 'viking-wc-icon') => {
      let r = gt(e),
        n = Rt.has(r),
        a = n ? (ct[r] ?? C[r]) : C[r];
      return n
        ? `<svg class="${i}" width="${t}" height="${t}" viewBox="0 0 24 24" fill="currentColor" fill-rule="evenodd" aria-hidden="true">${a}</svg>`
        : `<svg class="${i}" width="${t}" height="${t}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${a}</svg>`;
    },
    T = {
      accent: 'info',
      secondary: 'info',
...
`;
  var Dt = new Set([
    ...
    k = class extends HTMLElement {
      static tag = 'viking-badge-wc';
      static get observedAttributes() {
        return ['tone', 'size', 'icon', 'removable'];
      }
      shadow;
      constructor() {
        (super(), (this.shadow = this.attachShadow({ mode: 'open' })), c(this.shadow, pt));
      }
      connectedCallback() {
        this.render();
      }
      ...
      onRemove = () => {
        this.dispatchEvent(new CustomEvent('viking-removed', { bubbles: !0, composed: !0 }));
      };
      render() {
        let t = this.tone;
        t && this.getAttribute('tone') !== t
          ? this.setAttribute('tone', t)
          : !t && this.hasAttribute('tone') && this.removeAttribute('tone');
        let i = this.size;
        i && this.getAttribute('size') !== i
          ? this.setAttribute('size', i)
          : !i && this.hasAttribute('size') && this.removeAttribute('size');
        let r = this.getAttribute('icon') ?? (t ? T[t] : null),
          n = r ? h(r, 16) : '';
  ...
  var Pt = new Set(['outline', 'primary', 'secondary', 'filled', 'danger', 'ghost', 'subtle']),
    Kt = new Set(['sm', 'xs']),
    m = class extends HTMLElement {
      static tag = 'viking-button-wc';
      static get observedAttributes() {
        return [
          'variant',
          'size',
      ...
      control = null;
      constructor() {
        (super(), (this.shadow = this.attachShadow({ mode: 'open' })), c(this.shadow, ht));
      }
      connectedCallback() {
        (this.render(), this.control?.addEventListener('click', this.onClick));
      }
      ...
      onClick = t => {
        ...
        this.dispatchEvent(
          new CustomEvent('viking-press', { bubbles: !0, composed: !0, detail: t }),
        );
      };
      get variant() {
        let t = this.getAttribute('variant') ?? 'outline';
        return Pt.has(t) ? t : 'outline';
      }
      get size() {
        let t = this.getAttribute('size');
        return t && Kt.has(t) ? t : null;
      }
      get disabled() {
        return d(this, 'disabled');
      }
      get loading() {
        return d(this, 'loading');
      }
      get square() {
        return d(this, 'square');
      }
      render() {
        let t = this.getAttribute('href'),
          ...
          o = this.getAttribute('aria-busy') === 'true' || this.loading ? 'true' : null;
        ((this.shadow.innerHTML = `
      <${r}
        class="${n}"
        part="control"
    ...
    `),
          (this.control = this.shadow.querySelector(r)));
      }
    },
    O = () => {
      s(m.tag, m);
    };
  var Bt = new Set(['accent', 'secondary', 'success', 'warning', 'danger', 'info', 'muted']),
    b = class extends HTMLElement {
      static tag = 'viking-callout-wc';
      static get observedAttributes() {
        return ['tone', 'heading', 'icon', 'dismissible', 'hidden'];
      }
      shadow;
      constructor() {
        (super(), (this.shadow = this.attachShadow({ mode: 'open' })), c(this.shadow, ut));
      }
      connectedCallback() {
        this.render();
      }
      ...
      get tone() {
        let t = this.getAttribute('tone') ?? 'info';
        return Bt.has(t) ? t : 'info';
      }
      get dismissible() {
      ...
      onDismiss = () => {
        (this.setAttribute('hidden', ''),
          this.dispatchEvent(new CustomEvent('viking-close', { bubbles: !0, composed: !0 })));
      };
      render() {
        let t = this.getAttribute('heading') ?? '',
          i = this.getAttribute('icon') ?? T[this.tone] ?? 'info',
          r = h(i, 22, 'viking-callout-icon');
        ((this.shadow.innerHTML = `
  ...
  var f = class extends HTMLElement {
      ...
      attributeChangedCallback() {
        this.isConnected && this.syncClasses();
      }
      syncClasses() {
        ...
        t
          ? (this.setAttribute('role', 'region'), this.setAttribute('aria-label', t))
  ...
  var x = class extends HTMLElement {
      ...
      connectedCallback() {
        (this.render(), this.syncFormValue());
      }
      attributeChangedCallback(t) {
        if (this.isConnected) {
          if (t === 'value' && this.input) {
            ((this.input.value = this.getAttribute('value') ?? ''), this.syncFormValue());
            return;
          }
          this.render();
        }
      ...
      set value(t) {
        let i = t ?? '';
        (this.setAttribute('value', i), this.input && (this.input.value = i), this.syncFormValue());
      }
      get disabled() {
        return d(this, 'disabled');
      }
      ...
      onBlur = () => {
        this.dispatchEvent(new Event('blur', { bubbles: !0, composed: !0 }));
      };
      onClear = () => {
        ((this.value = ''),
          this.input?.focus(),
          this.dispatchEvent(new CustomEvent('viking-cleared', { bubbles: !0, composed: !0 })),
          this.dispatchEvent(new Event('input', { bubbles: !0, composed: !0 })));
      };
      syncFormValue() {
        L(this.internals, this.value);
      }
      render() {
        let t = [
            'viking-input-shell',
            ...
            .filter(Boolean)
            .join(' '),
          i = this.getAttribute('type') ?? 'text',
          r = this.getAttribute('placeholder') ?? '',
          n = this.getAttribute('value') ?? '',
          a = this.getAttribute('aria-label') ?? (r || 'Text input'),
          o = this.getAttribute('autocomplete') ?? '',
          v = this.clearable && n.length > 0 && !this.loading && !this.bare;
        (this.bare
          ? (this.shadow.innerHTML = `
        <input
          part="input"
      ...
      `),
          ...
          this.shadow
            .querySelector('.viking-input-clear')
  ...
  var y = class extends HTMLElement {
      ...
      dialogEl = null;
      constructor() {
        (super(), (this.shadow = this.attachShadow({ mode: 'open' })), c(this.shadow, mt));
      }
      connectedCallback() {
        (this.render(),
          this.syncOpen(),
      ...
      attributeChangedCallback(t) {
        if (this.isConnected) {
          ...
          t === 'dismissible' && (this.render(), this.syncOpen());
        }
      }
      openModal() {
        (this.setAttribute('open', ''), this.syncOpen());
      }
      closeModal() {
        (this.removeAttribute('open'), p(this.dialogEl));
      }
      open() {
        this.openModal();
      }
      ...
      onBackdropClick = t => {
        this.dismissible && t.target === this.dialogEl && this.closeModal();
      };
      syncOpen() {
        if (!this.dialogEl) return;
        let t = this.hasAttribute('open');
        t && !this.dialogEl.open
          ? (N(this.dialogEl),
            queueMicrotask(() => {
              (this.shadow.querySelector('.viking-modal-close') ?? this.dialogEl)?.focus();
            }))
          : !t && this.dialogEl.open && p(this.dialogEl);
      }
      updateTitle() {
        let t = this.getAttribute('title') ?? 'Dialog',
          i = this.shadow.querySelector('.viking-modal-heading');
        (i && (i.textContent = t), this.dialogEl?.setAttribute('aria-label', t));
      }
      render() {
        let t = this.getAttribute('title') ?? 'Dialog';
        ((this.shadow.innerHTML = `
    ...
    `),
          ...
          this.dialogEl?.addEventListener('keydown', i => {
            i.key === 'Escape' && this.dismissible && (i.preventDefault(), this.closeModal());
          }));
      }
    },
    D = () => {
  ...
  var Gt = e => {
    ...
    Wt = (e, t) =>
      [e.title, e.snippet ?? '', e.group ?? '', e.href, ...(e.keywords ?? [])]
        .join(' ')
        .toLowerCase()
        .includes(t),
    qt = (e, t) => {
      let i = t.trim().toLowerCase();
      return i ? e.filter(r => Wt(r, i)) : e;
    },
    Ut = e => {
      let t = new Map();
      return (
        ...
        Array.from(t.entries()).map(([i, r]) => ({ group: i, items: r }))
      );
    },
    w = class extends HTMLElement {
      static tag = 'viking-search-palette-wc';
      static get observedAttributes() {
      ...
      flatResults = [];
      constructor() {
        (super(), (this.shadow = this.attachShadow({ mode: 'open' })), c(this.shadow, bt));
      }
      connectedCallback() {
        (this.render(),
          this.syncOpen(),
      ...
      attributeChangedCallback(t) {
        if (
          this.isConnected &&
          (t === 'open' && this.syncOpen(), t === 'items' || t === 'placeholder')
        )
          if (t === 'placeholder' && this.inputEl) {
            let i =
              this.getAttribute('placeholder') ?? 'Search documentation, dashboard, API\u2026';
            ((this.inputEl.placeholder = i), this.inputEl.setAttribute('aria-label', i));
      ...
      search(t) {
        ((this.query = t),
          this.inputEl && (this.inputEl.value = t),
          (this.activeIndex = 0),
          this.renderResults(),
          this.dispatchEvent(
      ...
      onBackdropClick = t => {
        t.target === this.dialogEl && this.closePalette();
      };
      onInput = t => {
        ((this.query = t.target.value ?? this.inputEl?.value ?? ''),
          (this.activeIndex = 0),
          this.renderResults(),
          this.dispatchEvent(
            new CustomEvent('viking-query', {
      ...
      onInputKeydown = t => {
        if (this.flatResults.length !== 0) {
          ...
          if (t.key === 'Enter') {
            t.preventDefault();
            let i = this.flatResults[this.activeIndex];
            i && this.activateItem(i);
          }
        }
      };
      bindGlobalShortcut() {
        d(this, 'global-shortcut') &&
          ((this.globalKeyHandler = t => {
            (t.metaKey || t.ctrlKey) &&
              t.key.toLowerCase() === 'k' &&
              (t.preventDefault(),
              this.hasAttribute('open') ? this.closePalette() : this.openPalette());
          }),
      ...
      syncOpen() {
        ...
        t && !this.dialogEl.open
          ...
          : !t && this.dialogEl.open
            ? (p(this.dialogEl), this.dialogEl.setAttribute('aria-hidden', 'true'))
            : t || this.dialogEl.setAttribute('aria-hidden', 'true');
      }
      scrollActiveIntoView() {
        this.resultsEl
          ?.querySelector('.viking-search-result.is-selected')
          ?.scrollIntoView({ block: 'nearest' });
      }
      activateItem(t) {
        if (
          (this.dispatchEvent(
            new CustomEvent('viking-select', { bubbles: !0, composed: !0, detail: { item: t } }),
          ),
          this.closePalette(),
          t.action === 'cookie-settings')
        ) {
          globalThis.DemlWidgets?.openCookieSettings?.();
          return;
        }
        if (t.action === 'bug-report') {
          let i = globalThis.DemlWidgets;
          if (i?.openBugReport) {
            i.openBugReport();
            return;
          }
        }
        t.href && t.href !== '#' && window.location.assign(t.href);
      }
      renderResults() {
        if (!this.resultsEl) return;
        let t = Gt(this),
          i = this.query.trim().toLowerCase(),
          r = qt(t, i);
        if (((this.flatResults = r), r.length === 0)) {
          let g = this.query.trim();
          ((this.resultsEl.innerHTML = `<p class="viking-search-empty" role="status">${g ? 'No results found' : 'Start typing to search\u2026'}</p>`),
            this.inputEl?.removeAttribute('aria-activedescendant'));
          return;
        }
        this.activeIndex >= r.length && (this.activeIndex = r.length - 1);
        let n = 0,
          o = Ut(r)
            .map(({ group: g, items: A }) => {
              let q = g
                  ? `<p class="viking-search-group-label" role="presentation">${l(g)}</p>`
                  : '',
                V = A.map(_ => {
                  let Ct = `viking-search-result-${n}`,
                    tt = n === this.activeIndex;
                  return (
                    (n += 1),
                    `
              <a
            ...
            .join('');
        this.resultsEl.innerHTML = `<div class="viking-search-results" role="listbox">${o}</div>`;
        let v = `viking-search-result-${this.activeIndex}`;
        (this.inputEl?.setAttribute('aria-activedescendant', v),
          this.inputEl?.setAttribute('role', 'combobox'),
          this.inputEl?.setAttribute('aria-expanded', 'true'),
          this.inputEl?.setAttribute('aria-controls', 'viking-search-results-list'),
          this.resultsEl.querySelectorAll('.viking-search-result').forEach(g => {
            (g.addEventListener('click', A => {
              A.preventDefault();
              let q = Number(g.dataset.index ?? 0),
                V = this.flatResults[q];
              V && this.activateItem(V);
            }),
              g.addEventListener('mouseenter', () => {
                let A = Number(g.dataset.index ?? 0);
                ((this.activeIndex = A), this.renderResults());
              }));
          }));
      }
      render() {
        let t = this.getAttribute('placeholder') ?? 'Search documentation, dashboard, API\u2026',
          i = it();
        ((this.shadow.innerHTML = `
    ...
    `),
          ...
          this.dialogEl?.addEventListener('keydown', r => {
            r.key === 'Escape' && (r.preventDefault(), this.closePalette());
          }));
      }
    },
    I = () => {
  ...
  var ft = [
    ...
    xt = [
      {
        title: 'Platform',
        links: [
          { label: 'Explore', appHref: '/explore', marketingHref: '/explore', platform: !0 },
          { label: 'Dashboard', appHref: '/dashboard', marketingHref: '/dashboard', platform: !0 },
          { label: 'Sites', appHref: '/settings', marketingHref: '/settings', platform: !0 },
          { label: 'Account', appHref: '/account', marketingHref: '/account', platform: !0 },
          {
      ...
      },
      {
        ...
        links: [
          ...
          { label: 'Report a Bug', appHref: '#', marketingHref: '#', action: 'bug-report' },
        ],
      },
      {
        ...
        links: [
          ...
          { label: 'Cookie Settings', appHref: '#', marketingHref: '#', action: 'cookie-settings' },
        ],
      },
    ],
    Ft = 'reportBug=1',
    ...
    Z = e => `${P(e.app, '/')}?${Ft}`,
    X = e => `${P(e.marketing, '/')}?${jt}`,
    wt = (e, t) => (yt(e) || e.startsWith('mailto:') || e.startsWith('/') ? e : P(t.marketing, e)),
    It = (e, t, i) => (t === 'app' ? e : P(i.app, e)),
    Et = (e, t, i) =>
      e.platform ? It(e.appHref, t, i) : t === 'app' ? e.appHref : wt(e.marketingHref, i),
    St = (e, t, i) =>
      e.action === 'bug-report'
        ? t === 'app'
          ? '#'
          : Z(i)
        : e.action === 'cookie-settings'
          ? X(i)
          : e.platform
            ? It(e.appHref, t, i)
            : t === 'app'
              ? e.appHref
              : wt(e.marketingHref, i);
  var K = {
    app: 'https://deml.app',
  ...
  var Yt = e => {
    ...
    Zt = (e, t, i) => ({
      title: e.label,
      href: Et(e, t, i),
      snippet: `Open ${e.label}`,
      group: 'Platform',
      keywords: [e.id, e.label.toLowerCase(), 'navigate', 'go'],
    }),
    Xt = (e, t, i, r) =>
      e.action === 'cookie-settings'
        ? {
        ...
        : e.action === 'bug-report'
          ...
          : {
              ...
              snippet: `Open ${e.label}`,
              group: t,
              keywords: [e.label.toLowerCase(), t.toLowerCase()],
            },
    Qt = [
      {
    ...
    Jt = (e, t, i) => {
      switch (e.title) {
        ...
        case 'API reference':
          return `${i.backend.replace(/\/$/, '')}/api/docs`;
        default:
          return t === 'app' ? i.app : i.marketing;
      }
    },
    te = [
      {
    ...
    ee = (e, t) =>
      e.startsWith('http') ? e : `${t.replace(/\/$/, '')}${e.startsWith('/') ? e : `/${e}`}`,
    Q = (e, t, i) => {
      let r = e === 'docs' ? 'marketing' : e,
        n = [
          ...ft.map(a => Zt(a, r, t)),
          ...xt.flatMap(a => a.links.map(o => Xt(o, a.title, r, t))),
          ...Qt.map(a => ({ ...a, href: Jt(a, r, t) })),
        ];
      if (
        (e === 'app' &&
          n.push(
        ...
        let a = i?.docsOrigin ?? 'https://ui.dataengineeringformachinelearning.com';
        n.push(...te.map(o => ({ ...o, href: ee(o.href, a) })));
      }
      return Yt(n);
    };
  var Mt = new Set(['app', 'marketing', 'backend', 'docs']),
    ie = () => {
      let e = document.documentElement.getAttribute('data-deml-context');
      if (e && Mt.has(e)) return e;
      let t = window.location.hostname;
      return t.startsWith('ui.')
        ? 'docs'
        : t.includes('deml.app') && !t.startsWith('backend.')
          ? 'app'
    ...
    re = e => {
      let t = globalThis.__DEML ?? {};
      return {
        app: e.getAttribute('app-url') ?? t.app ?? K.app,
        marketing: e.getAttribute('marketing-url') ?? t.marketing ?? K.marketing,
        backend: e.getAttribute('backend-url') ?? t.backend ?? K.backend,
      };
    },
    ne = e => {
      let t = e.getAttribute('context');
      return t && Mt.has(t) ? t : ie();
    },
    E = class extends HTMLElement {
      static tag = 'viking-suite-search-palette-wc';
      static get observedAttributes() {
        return [
          'context',
          'app-url',
      ...
      itemsLoaded = !1;
      connectedCallback() {
        (I(), this.ensurePalette(), this.loadItems());
      }
      attributeChangedCallback(t) {
        if (this.isConnected) {
          if (t === 'placeholder' && this.paletteEl) {
            let i =
              this.getAttribute('placeholder') ?? 'Search documentation, dashboard, settings\u2026';
            this.paletteEl.setAttribute('placeholder', i);
            return;
          }
          if (t === 'global-shortcut' && this.paletteEl) {
            d(this, 'global-shortcut') || !this.hasAttribute('global-shortcut')
              ? this.paletteEl.setAttribute('global-shortcut', '')
              : this.paletteEl.removeAttribute('global-shortcut');
            return;
          }
          (t === 'context' || t === 'app-url' || t === 'marketing-url' || t === 'backend-url') &&
            this.loadItems(!0);
        }
      }
      openPalette() {
        (this.ensurePalette(), this.loadItems().then(() => this.paletteEl?.openPalette()));
      }
      closePalette() {
      ...
      ensurePalette() {
        ...
        ((this.paletteEl = document.createElement('viking-search-palette-wc')),
          (this.paletteEl.id = 'deml-command-palette'));
        let t =
          this.getAttribute('placeholder') ?? 'Search documentation, dashboard, settings\u2026';
        (this.paletteEl.setAttribute('placeholder', t),
          (d(this, 'global-shortcut') || !this.hasAttribute('global-shortcut')) &&
            this.paletteEl.setAttribute('global-shortcut', ''),
          this.append(this.paletteEl));
      }
      async loadItems(t = !1) {
        if (!this.paletteEl || (this.itemsLoaded && !t)) return;
        let i = ne(this),
          r = re(this),
          n = Q(i, r, { docsOrigin: window.location.origin });
        try {
          let a = await fetch('/assets/site-drakkar.json', { cache: 'no-cache' });
          if (a.ok) {
            let o = await a.json();
            (o.navLinks?.length || o.footerColumns?.length) &&
              (n = Q(i, r, { docsOrigin: window.location.origin }));
          }
        } catch {}
        (this.paletteEl.setAttribute('items', JSON.stringify(n)), (this.itemsLoaded = !0));
      }
    },
    B = () => {
      s(E.tag, E);
  ...
  var S = class extends HTMLElement {
      ...
      attributeChangedCallback(t) {
        if (this.isConnected) {
          if (t === 'value' && this.selectEl) {
            ((this.selectEl.value = this.getAttribute('value') ?? ''), this.syncFormValue());
            return;
          }
          if (t === 'error' || t === 'description' || t === 'label') {
            (this.render(), this.syncOptions());
            return;
          }
          (this.render(), this.syncOptions());
        }
      ...
      set value(t) {
        (this.setAttribute('value', t),
          this.selectEl && (this.selectEl.value = t),
          this.syncFormValue());
      }
      onChange = () => {
        let t = this.selectEl?.value ?? '';
        (this.setAttribute('value', t),
          this.syncFormValue(),
          this.dispatchEvent(
            new CustomEvent('viking-change', { bubbles: !0, composed: !0, detail: { value: t } }),
          ));
      };
      syncFormValue() {
        L(this.internals, this.value);
      ...
      observeOptions() {
        (this.optionObserver?.disconnect(),
          ...
          this.optionObserver.observe(this, { childList: !0, subtree: !0, characterData: !0 }));
      }
      render() {
        let t = this.getAttribute('label') ?? '',
          i = this.getAttribute('name') ?? '',
          r = this.hasAttribute('disabled'),
          n = this.hasAttribute('required'),
          a = this.getAttribute('error') ?? '',
          o = this.getAttribute('description') ?? '',
          v = [o && `${this.controlId}-desc`, a && `${this.controlId}-error`]
            .filter(Boolean)
            .join(' ');
        ((this.shadow.innerHTML = `
    ...
    `),
        ...
        let g = this.getAttribute('value');
        (this.selectEl && g && (this.selectEl.value = g), this.syncFormValue());
      }
      syncOptions() {
        if (!this.selectEl) return;
        let t = this.selectEl.value;
        this.selectEl.innerHTML = '';
        let i = this.querySelectorAll('option');
        if (i.length === 0) {
          let n = this.getAttribute('placeholder') ?? 'Select\u2026',
            a = document.createElement('option');
          ((a.value = ''),
            (a.textContent = n),
            (a.disabled = !0),
            (a.selected = !this.getAttribute('value')),
            this.selectEl.append(a));
          return;
        }
        i.forEach(n => {
          this.selectEl?.append(n.cloneNode(!0));
        });
        let r = this.getAttribute('value');
        (r ? (this.selectEl.value = r) : t && (this.selectEl.value = t), this.syncFormValue());
      }
    },
    G = () => {
      s(S.tag, S);
...
`,
    ...
    M = class extends HTMLElement {
      ...
      moonIcon = null;
      constructor() {
        (super(), (this.shadow = this.attachShadow({ mode: 'open' })), c(this.shadow, ae));
      }
      connectedCallback() {
        (this.render(), this.syncIcons(), this.button?.addEventListener('click', this.onClick));
      }
      disconnectedCallback() {
        this.button?.removeEventListener('click', this.onClick);
      }
      onClick = () => {
        let t = At() === 'light' ? 'dark' : 'light';
        (oe(t),
          this.syncIcons(),
          this.dispatchEvent(
      ...
      syncIcons = () => {
        let t = At() === 'light';
        (this.sunIcon?.classList.toggle('is-visible', t),
          this.moonIcon?.classList.toggle('is-visible', !t));
      };
      render() {
        let t = this.getAttribute('aria-label') ?? 'Toggle light and dark theme';
        ((this.shadow.innerHTML = `
