...
import { ConfirmDialogData } from '../components/confirm-dialog/confirm-dialog';

export type FluxDialogKind = 'confirm' | 'search' | 'onboarding';

export interface FluxDialogState {
  kind: FluxDialogKind;
  data?: ConfirmDialogData & { force?: boolean };
}

@Injectable({ providedIn: 'root' })
export class FluxDialogService {
  readonly active = signal<FluxDialogState | null>(null);
