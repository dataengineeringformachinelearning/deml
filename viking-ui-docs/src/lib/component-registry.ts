...
<button type="button" class="viking-btn viking-btn-outline">Outline</button>`,
  javascript: `<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@dataengineeringformachinelearning/viking-ui@10.0.0/dist/viking-ui.css" />
    ...
    <div class="viking-page-mockup-body mockup-body">
      ...
      <div class="viking-page-mockup-main mockup-main">
        ...
        <div class="viking-page-mockup-chart mockup-chart">
          ...
          <div class="chart-bar" data-height="63"></div>
          <div class="chart-bar" data-height="91"></div>
          <div class="chart-bar" data-height="78"></div>
