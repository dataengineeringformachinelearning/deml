    ...
    `;this.bare?this.shadow.innerHTML=`
      ...
      `:this.shadow.innerHTML=`
        <div class="${t}" part="shell">
          ...
          ${Qt?'<button type="button" class="viking-input-clear" aria-label="Clear input" part="clear">\xD7</button>':""}
...
`,ot=()=>{l(L.tag,L),d(L.legacyTag,L)};var xe=new Set(["accent","secondary","success","warning","danger","info","muted"]),T=class extends c{static tag="viking-status-pill";static legacyTag="viking-status-pill-wc";static get observedAttributes(){return["tone","icon","href","target","compact","dot","removable","aria-label"]}shadow;constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),u(this.shadow,ye)}connectedCallback(){this.render()}attributeChangedCallback(){this.isConnected&&this.render()}get tone(){let t=this.getAttribute("tone")??"muted";return xe.has(t)?t:"muted"}get compact(){let t=this.getAttribute("compact");return t!==null&&t!=="false"}get removable(){let t=this.getAttribute("removable");return t!==null&&t!=="false"}get href(){return this.getAttribute("href")}get icon(){return this.getAttribute("icon")}get showDot(){let t=this.getAttribute("dot");return t!==null&&t!=="false"}onRemove=()=>{this.dispatchEvent(new CustomEvent("viking-pill-removed",{bubbles:!0,composed:!0}))};render(){let t=this.tone,i=this.compact?" status-pill--compact":"",r=this.icon?h(this.icon,14,"status-pill__icon"):"",a=this.showDot?'<span class="status-pill__dot" aria-hidden="true"></span>':"",o='<span class="status-pill__label" part="label"><slot></slot></span>',s=n(this.getAttribute("aria-label")??""),v=this.href,g=this.getAttribute("target"),p=v&&g==="_blank"?' rel="noopener noreferrer"':"";if(v){this.shadow.innerHTML=`
    ...
    `,this.shadow.querySelector(".status-pill__remove")?.addEventListener("click",this.onRemove)}},ye=`
:host {
  display: inline-flex;
}
...
`,st=()=>{l(T.tag,T),d(T.legacyTag,T)};var B=[{id:"explore",label:"Explore",icon:"globe",appHref:"/explore",marketingHref:"/explore",platform:!0},{id:"documentation",label:"Documentation",icon:"file",appHref:"https://dataengineeringformachinelearning.com/documentation/",marketingHref:"/documentation"},{id:"dashboard",label:"Dashboard",icon:"home",appHref:"/dashboard",marketingHref:"/dashboard",requireAuth:!0,platform:!0},{id:"sites",label:"Sites",icon:"building",appHref:"/settings",marketingHref:"/settings",requireAuth:!0,platform:!0},{id:"account",label:"Account",icon:"user",appHref:"/account",marketingHref:"/account",requireAuth:!0,platform:!0}],lt=[{title:"Platform",links:[{label:"Explore",appHref:"/explore",marketingHref:"/explore",platform:!0},{label:"Dashboard",appHref:"/dashboard",marketingHref:"/dashboard",platform:!0},{label:"Sites",appHref:"/settings",marketingHref:"/settings",platform:!0},{label:"Account",appHref:"/account",marketingHref:"/account",platform:!0},{label:"Platform Status",appHref:"/status/platform-status",marketingHref:"/status/platform-status",platform:!0}]},{title:"Resources",links:[{label:"Documentation",appHref:"https://dataengineeringformachinelearning.com/documentation/",marketingHref:"/documentation"},{label:"Whitepaper",appHref:"https://dataengineeringformachinelearning.com/whitepaper/",marketingHref:"/whitepaper"},{label:"Book",appHref:"https://dataengineeringformachinelearning.com/book/",marketingHref:"/book"}]},{title:"Support",links:[{label:"Platform Status",appHref:"/status/platform-status",marketingHref:"/status/platform-status",platform:!0},{label:"Report a Bug",appHref:"#",marketingHref:"#",action:"bug-report"}]},{title:"Legal & Compliance",links:[{label:"Privacy Policy",appHref:"https://dataengineeringformachinelearning.com/privacy/",marketingHref:"/privacy"},{label:"Terms of Service",appHref:"https://dataengineeringformachinelearning.com/terms/",marketingHref:"/terms"},{label:"SOC2 Compliance",appHref:"https://dataengineeringformachinelearning.com/compliance/",marketingHref:"/compliance"},{label:"GDPR Compliance",appHref:"https://dataengineeringformachinelearning.com/privacy/#gdpr",marketingHref:"/privacy#gdpr"},{label:"Cookie Settings",appHref:"#",marketingHref:"#",action:"cookie-settings"}]}],we="reportBug=1",_e="cookieSettings=1",Kt=e=>/^https?:\/\//i.test(e),ct=(e,t)=>{if(Kt(t))return t;let i=e.replace(/\/$/,""),r=t.startsWith("/")?t:`/${t}`;return`${i}${r}`},xt=e=>`${ct(e.app,"/")}?${we}`,yt=e=>`${ct(e.marketing,"/")}?${_e}`,Wt=(e,t)=>Kt(e)||e.startsWith("mailto:")||e.startsWith("/")?e:ct(t.marketing,e),Ut=(e,t,i)=>t==="app"?e:ct(i.app,e),K=(e,t,i)=>e.platform?Ut(e.appHref,t,i):t==="app"?e.appHref:Wt(e.marketingHref,i),dt=(e,t,i)=>e.action==="bug-report"?t==="app"?"#":xt(i):e.action==="cookie-settings"?yt(i):e.platform?Ut(e.appHref,t,i):t==="app"?e.appHref:Wt(e.marketingHref,i),gt=(e,t)=>e==="marketing"?"/":t.marketing,Gt=(e,t=!1)=>e.filter(i=>!i.requireAuth||t);var b={app:"https://deml.app",marketing:"https://dataengineeringformachinelearning.com",backend:"https://backend.deml.app"};var qt=new Set(["app","marketing","backend","docs"]),Se=()=>{let e=document.documentElement.getAttribute("data-deml-context");if(e&&qt.has(e))return e;let t=window.location.hostname;return t.startsWith("backend.")?"backend":t.includes("deml.app")?"app":"marketing"},Ee=e=>{let t=e.getAttribute("context");return t&&qt.has(t)?t:Se()},Ie=e=>{let t=globalThis.__DEML??{};return{app:e.getAttribute("app-url")??t.app??b.app,marketing:e.getAttribute("marketing-url")??t.marketing??b.marketing,backend:e.getAttribute("backend-url")??t.backend??b.backend}},Ae=e=>{let t=e.getAttribute("year"),i=t?Number(t):new Date().getFullYear();return Number.isFinite(i)?i:new Date().getFullYear()},Me=(e,t)=>lt.map(i=>{let r=i.links.map(a=>{let o=dt(a,e,t);return`
    ...
    `}).join(""),V=class extends HTMLElement{static tag="viking-site-footer";static legacyTag="viking-site-footer-wc";static get observedAttributes(){return["context","app-url","marketing-url","backend-url","year"]}connectedCallback(){this.render()}attributeChangedCallback(){this.isConnected&&this.render()}render(){let t=Ee(this),i=Ie(this),r=Ae(this),a=Me(t,i);this.innerHTML=`
    ...
    `}},vt=()=>{l(V.tag,V),d(V.legacyTag,V)};var Ft=new Set(["app","marketing","backend","docs"]),Ce=()=>{let e=document.documentElement.getAttribute("data-deml-context");if(e&&Ft.has(e))return e;let t=window.location.hostname;return t.startsWith("ui.")?"docs":t.startsWith("backend.")?"backend":t.includes("deml.app")?"app":"marketing"},Le=e=>{let t=e.getAttribute("context");return t&&Ft.has(t)?t:Ce()},jt=(e,t)=>{let i=e.getAttribute(t);return i!==null&&i!=="false"},Te=e=>{let t=globalThis.__DEML??{};return{app:e.getAttribute("app-url")??t.app??b.app,marketing:e.getAttribute("marketing-url")??t.marketing??b.marketing,backend:e.getAttribute("backend-url")??t.backend??b.backend}},Ve=e=>jt(e,"authenticated"),$e=e=>e.getAttribute("show-search")===null?!0:jt(e,"show-search"),Ne=(e,t)=>{let i=e.getAttribute("sign-in-href");if(i)return i;let r=e.getAttribute("return-url")??window.location.href;return`${t.app}/login?returnUrl=${encodeURIComponent(r)}`},$=class extends HTMLElement{static tag="viking-site-navbar";static legacyTag="viking-site-navbar-wc";static get observedAttributes(){return["context","app-url","marketing-url","backend-url","authenticated","show-search","sign-in-href","dashboard-href","return-url"]}connectedCallback(){this.render()}attributeChangedCallback(){this.isConnected&&this.render()}renderNavLinks(t,i,r="desktop"){let a=r==="mobile"?"mobile-nav-btn":"nav-btn";return B.map(o=>{let s=K(o,t,i),v=o.requireAuth,g=v?" hidden":"",p=v?' data-require-auth="true"':"";return`
        <a
          href="${n(s)}"
          class="${a}"
          data-nav-id="${n(o.id)}"
    ...
    `:""}render(){let t=Le(this),i=Te(this),r=Ve(this),a=$e(this),o=gt(t,i),s=Ne(this,i),v=this.getAttribute("dashboard-href")??`${i.app}/dashboard`,g=this.renderNavLinks(t,i,"desktop"),p=this.renderNavLinks(t,i,"mobile"),f=this.renderAuthDesktop(r,s,v),m=this.renderAuthMobile(r,v,s),x=this.renderSearchButton(a);this.innerHTML=`
      <header class="navbar">
    ...
    `}},ht=()=>{l($.tag,$),d($.legacyTag,$)};var He=e=>{let t=new Set;return e.filter(i=>{let r=`${i.title}:${i.href}:${i.action??""}`;return t.has(r)?!1:(t.add(r),!0)})},De=(e,t,i)=>({title:e.label,href:K(e,t,i),snippet:`Open ${e.label}`,group:"Platform",keywords:[e.id,e.label.toLowerCase(),"navigate","go"]}),Oe=(e,t,i,r)=>e.action==="cookie-settings"?{title:e.label,href:yt(r),snippet:"Manage analytics and cookie preferences",group:t,keywords:["cookies","consent","privacy","gdpr"],action:"cookie-settings"}:e.action==="bug-report"?{title:e.label,href:i==="app"?"#":xt(r),snippet:"Submit a product issue or regression",group:t,keywords:["bug","issue","support","feedback"],action:"bug-report"}:{title:e.label,href:dt(e,i,r),snippet:`Open ${e.label}`,group:t,keywords:[e.label.toLowerCase(),t.toLowerCase()]},ze=[{title:"Viking-UI Components",snippet:"Browse the design system showcase",group:"Resources",keywords:["viking","ui","design system","components","showcase"]},{title:"Design tokens",snippet:"Canonical --viking-* token matrix",group:"Resources",keywords:["tokens","theme","css","variables"]},{title:"API reference",snippet:"OpenAPI schema and REST endpoints",group:"Resources",keywords:["api","openapi","swagger","rest"]}],Re=(e,t,i)=>{switch(e.title){case"Viking-UI Components":return"https://ui.dataengineeringformachinelearning.com/components";case"Design tokens":return"https://ui.dataengineeringformachinelearning.com/tokens";case"API reference":return`${i.backend.replace(/\/$/,"")}/api/docs`;default:return t==="app"?i.app:i.marketing}},Pe=[{title:"Components",href:"/components",snippet:"Browse all documented primitives",group:"Viking-UI",keywords:["components","showcase","registry"]},{title:"Playground",href:"/playground",snippet:"Live Web Component sandbox",group:"Viking-UI",keywords:["playground","sandbox","demo"]},{title:"Architecture",href:"/architecture",snippet:"CSS + WC + Angular layers",group:"Viking-UI",keywords:["architecture","layers","web component"]},{title:"Design tokens",href:"/tokens",snippet:"Canonical --viking-* token matrix",group:"Viking-UI",keywords:["tokens","theme","css","variables"]},{title:"Theming",href:"/theming",snippet:"Light/dark mode and sync pipeline",group:"Viking-UI",keywords:["theming","dark","light","mode"]},{title:"Framework guides",href:"/frameworks",snippet:"Angular, Astro, Django setup",group:"Viking-UI",keywords:["frameworks","angular","astro","django"]},{title:"Contributing",href:"/contributing",snippet:"Extend the Viking-UI kit",group:"Viking-UI",keywords:["contributing","extend","primitives"]}],Be=(e,t)=>e.startsWith("http")?e:`${t.replace(/\/$/,"")}${e.startsWith("/")?e:`/${e}`}`,wt=(e,t,i)=>{let r=e==="docs"?"marketing":e,a=[...B.map(o=>De(o,r,t)),...lt.flatMap(o=>o.links.map(s=>Oe(s,o.title,r,t))),...ze.map(o=>({...o,href:Re(o,r,t)}))];if(e==="app"&&a.push({title:"Settings",href:"/settings",snippet:"Workspace domains, billing, and security",group:"Platform",keywords:["settings","sites","workspace","configuration"]},{title:"Billing & subscription",href:"/settings/billing",snippet:"Manage plan, invoices, and payment methods",group:"Platform",keywords:["billing","stripe","subscription","payment"]},{title:"Security settings",href:"/settings/security",snippet:"Keys, sessions, and access controls",group:"Platform",keywords:["security","keys","auth","rbac"]}),e==="docs"){let o=i?.docsOrigin??"https://ui.dataengineeringformachinelearning.com";a.push(...Pe.map(s=>({...s,href:Be(s.href,o)})))}return He(a)};var Yt=new Set(["app","marketing","backend","docs"]),Ke=()=>{let e=document.documentElement.getAttribute("data-deml-context");if(e&&Yt.has(e))return e;let t=window.location.hostname;return t.startsWith("ui.")?"docs":t.includes("deml.app")&&!t.startsWith("backend.")?"app":t.startsWith("backend.")?"backend":"marketing"},We=e=>{let t=globalThis.__DEML??{};return{app:e.getAttribute("app-url")??t.app??b.app,marketing:e.getAttribute("marketing-url")??t.marketing??b.marketing,backend:e.getAttribute("backend-url")??t.backend??b.backend}},Ue=e=>{let t=e.getAttribute("context");return t&&Yt.has(t)?t:Ke()},w=class extends c{static tag="viking-suite-command-palette";static searchTag="viking-suite-search-palette";static legacyTag="viking-suite-search-palette-wc";static get observedAttributes(){return["context","app-url","marketing-url","backend-url","placeholder","global-shortcut"]}paletteEl=null;itemsLoaded=!1;connectedCallback(){P(),this.ensurePalette(),this.loadItems()}attributeChangedCallback(t){if(this.isConnected){if(t==="placeholder"&&this.paletteEl){let i=this.getAttribute("placeholder")??"Search documentation, dashboard, settings\u2026";this.paletteEl.setAttribute("placeholder",i);return}if(t==="global-shortcut"&&this.paletteEl){k(this,"global-shortcut")||!this.hasAttribute("global-shortcut")?this.paletteEl.setAttribute("global-shortcut",""):this.paletteEl.removeAttribute("global-shortcut");return}(t==="context"||t==="app-url"||t==="marketing-url"||t==="backend-url")&&this.loadItems(!0)}}openPalette(){this.ensurePalette(),this.loadItems().then(()=>this.paletteEl?.openPalette())}closePalette(){this.paletteEl?.closePalette()}ensurePalette(){if(this.paletteEl)return;this.paletteEl=document.createElement("viking-command-palette"),this.paletteEl.id="deml-command-palette";let t=this.getAttribute("placeholder")??"Search documentation, dashboard, settings\u2026";this.paletteEl.setAttribute("placeholder",t),(k(this,"global-shortcut")||!this.hasAttribute("global-shortcut"))&&this.paletteEl.setAttribute("global-shortcut",""),this.append(this.paletteEl)}async loadItems(t=!1){if(!this.paletteEl||this.itemsLoaded&&!t)return;let i=Ue(this),r=We(this),a=wt(i,r,{docsOrigin:window.location.origin});try{let o=await fetch("/assets/site-drakkar.json",{cache:"no-cache"});if(o.ok){let s=await o.json();(s.navLinks?.length||s.footerColumns?.length)&&(a=wt(i,r,{docsOrigin:window.location.origin}))}}catch{}this.paletteEl.setAttribute("items",JSON.stringify(a)),this.itemsLoaded=!0}},W=()=>{l(w.tag,w),d(w.searchTag,w),d(w.legacyTag,w)};var Xt=`
:host {
  display: inline-flex;
}
...
`,Ge=e=>{document.documentElement.setAttribute("data-theme",e),document.documentElement.classList.toggle("dark",e==="dark"),localStorage.setItem("theme",e)},Zt=()=>{let e=localStorage.getItem("theme");return e==="light"||e==="dark"?e:window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"},U=class extends c{static tag="viking-theme-toggle-wc";shadow;button=null;sunIcon=null;moonIcon=null;onStorage=()=>{this.syncIcons()};constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),u(this.shadow,Xt)}connectedCallback(){this.render(),this.syncIcons(),this.button?.addEventListener("click",this.onClick),window.addEventListener("storage",this.onStorage),window.addEventListener("viking-theme-change",this.onThemeChange)}disconnectedCallback(){this.button?.removeEventListener("click",this.onClick),window.removeEventListener("storage",this.onStorage),window.removeEventListener("viking-theme-change",this.onThemeChange)}onThemeChange=()=>{this.syncIcons()};onClick=()=>{let t=Zt()==="light"?"dark":"light";Ge(t),this.syncIcons(),this.dispatchEvent(new CustomEvent("viking-theme-change",{bubbles:!0,composed:!0,detail:{theme:t}}))};syncIcons=()=>{let t=Zt()==="dark";this.sunIcon?.classList.toggle("is-visible",t),this.moonIcon?.classList.toggle("is-visible",!t)};render(){let t=this.getAttribute("aria-label")??"Toggle light and dark theme";this.shadow.innerHTML=`
    ...
    `,u(this.shadow,Xt),this.button=this.shadow.querySelector("button"),this.sunIcon=this.shadow.querySelector(".theme-icon-sun"),this.moonIcon=this.shadow.querySelector(".theme-icon-moon")}},G=()=>{l(U.tag,U)};var Jt=new Set(["app","marketing","backend","docs"]),qe=`
:host {
  display: block;
  position: sticky;
  top: 0;
