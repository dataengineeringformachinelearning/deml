...
`;var ge=new Set(["accent","secondary","success","warning","danger","info","muted","subtle"]),S=class extends c{static tag="viking-badge";static legacyTag="viking-badge-wc";static get observedAttributes(){return["tone","size","icon","removable"]}shadow;constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),u(this.shadow,zt)}connectedCallback(){this.render()}attributeChangedCallback(){this.isConnected&&this.render()}get tone(){let t=this.getAttribute("tone")??"";return ge.has(t)?t:null}get size(){return this.getAttribute("size")==="sm"?"sm":null}get removable(){return this.hasAttribute("removable")&&this.getAttribute("removable")!=="false"}onRemove=()=>{this.dispatchEvent(new CustomEvent("viking-removed",{bubbles:!0,composed:!0}))};render(){let t=this.tone;t&&this.getAttribute("tone")!==t?this.setAttribute("tone",t):!t&&this.hasAttribute("tone")&&this.removeAttribute("tone");let i=this.size;i&&this.getAttribute("size")!==i?this.setAttribute("size",i):!i&&this.hasAttribute("size")&&this.removeAttribute("size");let r=this.getAttribute("icon")??(t?Q[t]:null),a=r?v(r,16):"";this.shadow.innerHTML=`
    ...
    `,this.dialogEl=this.shadow.querySelector("dialog"),this.shadow.querySelector(".viking-modal-close")?.addEventListener("click",()=>this.closeModal()),this.dialogEl?.addEventListener("keydown",i=>{i.key==="Escape"&&this.dismissible&&(i.preventDefault(),this.closeModal())})}},ot=()=>{l(C.tag,C),d(C.dialogTag,C)};var pe=e=>{let t=e.getAttribute("items");if(!t)return[];try{let i=JSON.parse(t);return Array.isArray(i)?i:[]}catch{return[]}},ke=(e,t)=>[e.title,e.snippet??"",e.group??"",e.href,...e.keywords??[]].join(" ").toLowerCase().includes(t),be=(e,t)=>{let i=t.trim().toLowerCase();return i?e.filter(r=>ke(r,i)):e},me=e=>{let t=new Map;return e.forEach(i=>{let r=i.group??null,a=t.get(r)??[];a.push(i),t.set(r,a)}),Array.from(t.entries()).map(([i,r])=>({group:i,items:r}))},y=class extends c{static tag="viking-command-palette";static searchTag="viking-search-palette";static legacyTag="viking-search-palette-wc";static get observedAttributes(){return["open","placeholder","items","global-shortcut"]}shadow;dialogEl=null;inputEl=null;resultsEl=null;globalKeyHandler=null;resultsId=_("viking-search-results");inputId=_("viking-search-input");query="";activeIndex=0;flatResults=[];constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),u(this.shadow,Kt)}connectedCallback(){this.render(),this.removeAttribute("open"),this.syncOpen(),this.bindGlobalShortcut(),this.dialogEl?.addEventListener("close",this.onClose),this.dialogEl?.addEventListener("click",this.onBackdropClick),this.inputEl?.addEventListener("input",this.onInput),this.inputEl?.addEventListener("keydown",this.onInputKeydown)}disconnectedCallback(){this.dialogEl?.removeEventListener("close",this.onClose),this.dialogEl?.removeEventListener("click",this.onBackdropClick),this.inputEl?.removeEventListener("input",this.onInput),this.inputEl?.removeEventListener("keydown",this.onInputKeydown),this.unbindGlobalShortcut()}attributeChangedCallback(t){if(this.isConnected&&(t==="open"&&this.syncOpen(),t==="global-shortcut"&&(this.unbindGlobalShortcut(),this.bindGlobalShortcut()),t==="items"||t==="placeholder"))if(t==="placeholder"&&this.inputEl){let i=this.getAttribute("placeholder")??"Search documentation, dashboard, API\u2026";this.inputEl.placeholder=i,this.inputEl.setAttribute("aria-label",i)}else this.renderResults()}openPalette(){this.setAttribute("open",""),this.syncOpen()}closePalette(){this.removeAttribute("open"),O(this.dialogEl)}search(t){this.query=t,this.inputEl&&(this.inputEl.value=t),this.activeIndex=0,this.renderResults(),this.dispatchEvent(new CustomEvent("viking-query",{bubbles:!0,composed:!0,detail:{query:this.query}}))}onClose=()=>{this.removeAttribute("open"),this.query="",this.activeIndex=0,this.inputEl&&(this.inputEl.value=""),this.dispatchEvent(new CustomEvent("viking-close",{bubbles:!0,composed:!0}))};onBackdropClick=t=>{t.target===this.dialogEl&&this.closePalette()};onInput=t=>{this.query=t.target.value??this.inputEl?.value??"",this.activeIndex=0,this.renderResults(),this.dispatchEvent(new CustomEvent("viking-query",{bubbles:!0,composed:!0,detail:{query:this.query}}))};onInputKeydown=t=>{if(this.flatResults.length===0){t.key==="Escape"&&(t.preventDefault(),this.closePalette());return}if(t.key==="ArrowDown"){t.preventDefault(),this.activeIndex=Math.min(this.flatResults.length-1,this.activeIndex+1),this.renderResults(),this.scrollActiveIntoView();return}if(t.key==="ArrowUp"){t.preventDefault(),this.activeIndex=Math.max(0,this.activeIndex-1),this.renderResults(),this.scrollActiveIntoView();return}if(t.key==="Enter"){t.preventDefault();let i=this.flatResults[this.activeIndex];i&&this.activateItem(i)}};bindGlobalShortcut(){k(this,"global-shortcut")&&(this.globalKeyHandler=t=>{(t.metaKey||t.ctrlKey)&&t.key.toLowerCase()==="k"&&(t.preventDefault(),this.hasAttribute("open")?this.closePalette():this.openPalette())},document.addEventListener("keydown",this.globalKeyHandler))}unbindGlobalShortcut(){this.globalKeyHandler&&(document.removeEventListener("keydown",this.globalKeyHandler),this.globalKeyHandler=null)}syncOpen(){if(!this.dialogEl)return;let t=this.hasAttribute("open");t&&!this.dialogEl.open?(this.dialogEl.removeAttribute("aria-hidden"),Z(this.dialogEl),this.activeIndex=0,this.renderResults(),queueMicrotask(()=>this.inputEl?.focus())):!t&&this.dialogEl.open?(O(this.dialogEl),this.dialogEl.setAttribute("aria-hidden","true")):t||this.dialogEl.setAttribute("aria-hidden","true")}scrollActiveIntoView(){this.resultsEl?.querySelector(".viking-search-result.is-selected")?.scrollIntoView({block:"nearest"})}activateItem(t){if(this.dispatchEvent(new CustomEvent("viking-select",{bubbles:!0,composed:!0,detail:{item:t}})),this.closePalette(),t.action==="cookie-settings"){globalThis.DemlWidgets?.openCookieSettings?.();return}if(t.action==="bug-report"){let i=globalThis.DemlWidgets;if(i?.openBugReport){i.openBugReport();return}}t.href&&t.href!=="#"&&window.location.assign(t.href)}renderResults(){if(!this.resultsEl)return;let t=pe(this),i=this.query.trim().toLowerCase(),r=be(t,i);if(this.flatResults=r,r.length===0){let g=this.query.trim();this.resultsEl.innerHTML=`<p class="viking-search-empty" role="status">${g?"No results found":"Start typing to search\u2026"}</p>`,this.inputEl?.removeAttribute("aria-activedescendant");return}this.activeIndex>=r.length&&(this.activeIndex=r.length-1);let a=0,s=me(r).map(({group:g,items:p})=>{let f=g?`<p class="viking-search-group-label" role="presentation">${n(g)}</p>`:"",m=p.map(x=>{let H=`${this.resultsId}-result-${a}`,D=a===this.activeIndex;return a+=1,`
              ...
              </a>`}).join("");return`${f}${m}`}).join("");this.resultsEl.innerHTML=`<div class="viking-search-results" id="${this.resultsId}" role="listbox" aria-label="Search results">${s}</div>`;let h=`${this.resultsId}-result-${this.activeIndex}`;this.inputEl?.setAttribute("aria-activedescendant",h),this.inputEl?.setAttribute("role","combobox"),this.inputEl?.setAttribute("aria-expanded","true"),this.inputEl?.setAttribute("aria-controls",this.resultsId),this.resultsEl.querySelectorAll(".viking-search-result").forEach(g=>{g.addEventListener("click",p=>{p.preventDefault();let f=Number(g.dataset.index??0),m=this.flatResults[f];m&&this.activateItem(m)}),g.addEventListener("mouseenter",()=>{let p=Number(g.dataset.index??0);this.activeIndex=p,this.renderResults()})})}render(){let t=this.getAttribute("placeholder")??"Search documentation, dashboard, API\u2026",i=J();this.shadow.innerHTML=`
...
`,lt=()=>{l(T.tag,T),d(T.legacyTag,T)};var B=[{id:"explore",label:"Explore",icon:"globe",appHref:"/explore",marketingHref:"/explore",platform:!0},{id:"documentation",label:"Documentation",icon:"file",appHref:"https://dataengineeringformachinelearning.com/documentation/",marketingHref:"/documentation"},{id:"dashboard",label:"Dashboard",icon:"home",appHref:"/dashboard",marketingHref:"/dashboard",requireAuth:!0,platform:!0},{id:"sites",label:"Sites",icon:"building",appHref:"/settings",marketingHref:"/settings",requireAuth:!0,platform:!0},{id:"account",label:"Account",icon:"user",appHref:"/account",marketingHref:"/account",requireAuth:!0,platform:!0}],ct=[{title:"Platform",links:[{label:"Explore",appHref:"/explore",marketingHref:"/explore",platform:!0},{label:"Dashboard",appHref:"/dashboard",marketingHref:"/dashboard",platform:!0},{label:"Sites",appHref:"/settings",marketingHref:"/settings",platform:!0},{label:"Account",appHref:"/account",marketingHref:"/account",platform:!0},{label:"Platform Status",appHref:"/status/platform-status",marketingHref:"/status/platform-status",platform:!0}]},{title:"Resources",links:[{label:"Documentation",appHref:"https://dataengineeringformachinelearning.com/documentation/",marketingHref:"/documentation"},{label:"Whitepaper",appHref:"https://dataengineeringformachinelearning.com/whitepaper/",marketingHref:"/whitepaper"},{label:"Book",appHref:"https://dataengineeringformachinelearning.com/book/",marketingHref:"/book"}]},{title:"Support",links:[{label:"Platform Status",appHref:"/status/platform-status",marketingHref:"/status/platform-status",platform:!0},{label:"Report a Bug",appHref:"#",marketingHref:"#",action:"bug-report"}]},{title:"Legal & Compliance",links:[{label:"Privacy Policy",appHref:"https://dataengineeringformachinelearning.com/privacy/",marketingHref:"/privacy"},{label:"Terms of Service",appHref:"https://dataengineeringformachinelearning.com/terms/",marketingHref:"/terms"},{label:"SOC2 Compliance",appHref:"https://dataengineeringformachinelearning.com/compliance/",marketingHref:"/compliance"},{label:"GDPR Compliance",appHref:"https://dataengineeringformachinelearning.com/privacy/#gdpr",marketingHref:"/privacy#gdpr"},{label:"Cookie Settings",appHref:"#",marketingHref:"#",action:"cookie-settings"}]}],_e="reportBug=1",Se="cookieSettings=1",Wt=e=>/^https?:\/\//i.test(e),dt=(e,t)=>{if(Wt(t))return t;let i=e.replace(/\/$/,""),r=t.startsWith("/")?t:`/${t}`;return`${i}${r}`},yt=e=>`${dt(e.app,"/")}?${_e}`,wt=e=>`${dt(e.marketing,"/")}?${Se}`,Ut=(e,t)=>Wt(e)||e.startsWith("mailto:")||e.startsWith("/")?e:dt(t.marketing,e),qt=(e,t,i)=>t==="app"?e:dt(i.app,e),K=(e,t,i)=>e.platform?qt(e.appHref,t,i):t==="app"?e.appHref:Ut(e.marketingHref,i),gt=(e,t,i)=>e.action==="bug-report"?t==="app"?"#":yt(i):e.action==="cookie-settings"?wt(i):e.platform?qt(e.appHref,t,i):t==="app"?e.appHref:Ut(e.marketingHref,i),vt=(e,t)=>e==="marketing"?"/":t.marketing,Gt=(e,t=!1)=>e.filter(i=>!i.requireAuth||t);var b={app:"https://deml.app",marketing:"https://dataengineeringformachinelearning.com",backend:"https://backend.deml.app"};var Ft=new Set(["app","marketing","backend","docs"]),Ee=()=>{let e=document.documentElement.getAttribute("data-deml-context");if(e&&Ft.has(e))return e;let t=window.location.hostname;return t.startsWith("backend.")?"backend":t.includes("deml.app")?"app":"marketing"},Ie=e=>{let t=e.getAttribute("context");return t&&Ft.has(t)?t:Ee()},Ae=e=>{let t=globalThis.__DEML??{};return{app:e.getAttribute("app-url")??t.app??b.app,marketing:e.getAttribute("marketing-url")??t.marketing??b.marketing,backend:e.getAttribute("backend-url")??t.backend??b.backend}},Me=e=>{let t=e.getAttribute("year"),i=t?Number(t):new Date().getFullYear();return Number.isFinite(i)?i:new Date().getFullYear()},Ce=(e,t)=>ct.map(i=>{let r=i.links.map(a=>{let o=gt(a,e,t);return`
    ...
    `}).join(""),V=class extends HTMLElement{static tag="viking-site-footer";static legacyTag="viking-site-footer-wc";static get observedAttributes(){return["context","app-url","marketing-url","backend-url","year"]}connectedCallback(){this.render()}attributeChangedCallback(){this.isConnected&&this.render()}render(){let t=Ie(this),i=Ae(this),r=Me(this),a=Ce(t,i);this.innerHTML=`
    ...
    `,this.bindUsaBadge()}emitUsaBadgeHover=t=>{if(t.type==="keydown"){let i=t.key;if(i!=="Enter"&&i!==" ")return;t.preventDefault()}this.dispatchEvent(new CustomEvent("usaBadgeHover",{bubbles:!0,composed:!0,detail:t}))};bindUsaBadge(){let t=this.querySelector("#usa-badge");t&&(t.addEventListener("mouseenter",this.emitUsaBadgeHover),t.addEventListener("focusin",this.emitUsaBadgeHover),t.addEventListener("click",this.emitUsaBadgeHover),t.addEventListener("keydown",this.emitUsaBadgeHover))}},ht=()=>{l(V.tag,V),d(V.legacyTag,V)};var jt=new Set(["app","marketing","backend","docs"]),Le=()=>{let e=document.documentElement.getAttribute("data-deml-context");if(e&&jt.has(e))return e;let t=window.location.hostname;return t.startsWith("ui.")?"docs":t.startsWith("backend.")?"backend":t.includes("deml.app")?"app":"marketing"},Te=e=>{let t=e.getAttribute("context");return t&&jt.has(t)?t:Le()},Yt=(e,t)=>{let i=e.getAttribute(t);return i!==null&&i!=="false"},Ve=e=>{let t=globalThis.__DEML??{};return{app:e.getAttribute("app-url")??t.app??b.app,marketing:e.getAttribute("marketing-url")??t.marketing??b.marketing,backend:e.getAttribute("backend-url")??t.backend??b.backend}},$e=e=>Yt(e,"authenticated"),Ne=e=>e.getAttribute("show-search")===null?!0:Yt(e,"show-search"),He=(e,t)=>{let i=e.getAttribute("sign-in-href");if(i)return i;let r=e.getAttribute("return-url")??window.location.href;return`${t.app}/login?returnUrl=${encodeURIComponent(r)}`},W=(e,t,i={})=>{let r=i.id?` id="${n(i.id)}"`:"",a=i.color?` data-viking-icon-color="${n(i.color)}"`:"",o=i.className?` class="${n(i.className)}"`:"";return`<span${r}${o} data-viking-icon="${n(e)}" data-viking-icon-size="${t}"${a} aria-hidden="true">${v(e,t,"viking-navbar-inline-icon")}</span>`},$=class extends HTMLElement{static tag="viking-site-navbar";static legacyTag="viking-site-navbar-wc";static get observedAttributes(){return["context","app-url","marketing-url","backend-url","authenticated","show-search","sign-in-href","dashboard-href","return-url"]}connectedCallback(){this.render()}attributeChangedCallback(){this.isConnected&&this.render()}renderNavLinks(t,i,r="desktop"){let a=r==="mobile"?"mobile-nav-btn":"nav-btn";return B.map(o=>{let s=K(o,t,i),h=o.requireAuth,g=h?" hidden":"",p=h?' data-require-auth="true"':"";return`
        <a
          href="${n(s)}"
          class="${a}"
          data-nav-id="${n(o.id)}"
      ...
      <div class="desktop-auth">
        <viking-button-wc
          ...
          id="auth-btn-desktop"
        >
          ${W(t?"home":"arrow-right",16,{id:"auth-icon-desktop"})}
    ...
    `}renderAuthMobile(t,i,r){return`
      ...
      <viking-button-wc
        ...
        id="auth-btn-mobile"
      >
        ${W(t?"home":"arrow-right",16,{id:"auth-icon-mobile"})}
    ...
    `:""}render(){let t=Te(this),i=Ve(this),r=$e(this),a=Ne(this),o=vt(t,i),s=He(this,i),h=this.getAttribute("dashboard-href")??`${i.app}/dashboard`,g=this.renderNavLinks(t,i,"desktop"),p=this.renderNavLinks(t,i,"mobile"),f=this.renderAuthDesktop(r,s,h),m=this.renderAuthMobile(r,h,s),x=this.renderSearchButton(a);this.innerHTML=`
      <header class="navbar">
        <div class="navbar-content">
          <div class="navbar-left">
            <a href="${n(o)}" class="navbar-brand" aria-label="Go to homepage" id="navbar-brand-link">
              ${W("drakkar",28,{color:"accent",className:"brand-icon navbar-logo"})}
            </a>
          </div>
...
`,je=()=>{let e=document.documentElement.getAttribute("data-deml-context");if(e&&Qt.has(e))return e;let t=window.location.hostname;return t.startsWith("ui.")?"docs":t.startsWith("backend.")?"backend":t.includes("deml.app")?"app":"marketing"},Ye=e=>{let t=e.getAttribute("context");return t&&Qt.has(t)?t:je()},Xe=e=>{let t=globalThis.__DEML??{};return{app:e.getAttribute("app-url")??t.app??b.app,marketing:e.getAttribute("marketing-url")??t.marketing??b.marketing,backend:e.getAttribute("backend-url")??t.backend??b.backend}},Ze=e=>{try{let t=new URL(e,window.location.origin);return t.origin===window.location.origin&&t.pathname===window.location.pathname}catch{return!1}},F=class extends c{static tag="viking-suite-header";static get observedAttributes(){return["context","app-url","marketing-url","backend-url","authenticated","user-name","user-email","sign-in-href","dashboard-href"]}shadow;menuOpen=!1;userMenuOpen=!1;paletteEl=null;constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),u(this.shadow,Fe)}connectedCallback(){G(),U(),this.render(),document.addEventListener("click",this.onDocumentClick)}disconnectedCallback(){document.removeEventListener("click",this.onDocumentClick)}attributeChangedCallback(){this.isConnected&&this.render()}openSearch(){this.paletteEl?.openPalette(),this.dispatchEvent(new CustomEvent("viking-search-open",{bubbles:!0,composed:!0}))}onDocumentClick=t=>{t.composedPath().includes(this)||(this.menuOpen||this.userMenuOpen)&&(this.menuOpen=!1,this.userMenuOpen=!1,this.syncOpenState())};onSearchClick=()=>{this.openSearch()};onMenuClick=()=>{this.menuOpen=!this.menuOpen,this.syncOpenState()};onUserClick=()=>{this.userMenuOpen=!this.userMenuOpen,this.syncOpenState()};onSignInClick=t=>{let i=new CustomEvent("viking-sign-in",{bubbles:!0,cancelable:!0,composed:!0,detail:t});this.dispatchEvent(i),i.defaultPrevented&&t.preventDefault()};onSignOutClick=()=>{this.userMenuOpen=!1,this.menuOpen=!1,this.syncOpenState(),this.dispatchEvent(new CustomEvent("viking-sign-out",{bubbles:!0,composed:!0}))};syncOpenState(){let t=this.shadow.querySelector(".suite-header"),i=this.shadow.querySelector("[data-menu-toggle]"),r=this.shadow.querySelector(".suite-header__user"),a=this.shadow.querySelector("[data-user-toggle]");t?.setAttribute("data-menu-open",String(this.menuOpen)),i?.setAttribute("aria-expanded",String(this.menuOpen)),r?.setAttribute("data-open",String(this.userMenuOpen)),a?.setAttribute("aria-expanded",String(this.userMenuOpen))}renderNavLinks(t,i,r){return Gt(B,r).map(a=>{let o=K(a,t,i),s=Ze(o)?' aria-current="page"':"";return`
    ...
    `}getDashboardHref(t){return this.getAttribute("dashboard-href")??`${t.app}/dashboard`}render(){let t=Ye(this),i=Xe(this),r=k(this,"authenticated"),a=this.renderNavLinks(t,i,r),o=vt(t,i),s=`${J()}K`;this.shadow.innerHTML=`
