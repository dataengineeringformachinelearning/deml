...
- **jsDelivr CDN alternative after publish**: `https://cdn.jsdelivr.net/npm/@dataengineeringformachinelearning/viking-ui@4.1.10/dist/viking-ui.css` and `https://cdn.jsdelivr.net/npm/@dataengineeringformachinelearning/viking-ui@4.1.10/dist/web-components.js`
