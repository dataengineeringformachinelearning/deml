...
- **jsDelivr CDN alternative after publish**: `https://cdn.jsdelivr.net/npm/@dataengineeringformachinelearning/viking-ui@9.2.0/dist/viking-ui.css` and `https://cdn.jsdelivr.net/npm/@dataengineeringformachinelearning/viking-ui@9.2.0/dist/web-components.js`
