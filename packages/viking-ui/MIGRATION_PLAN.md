...
- Astro marketing and showcase load `@dataengineeringformachinelearning/viking-ui/viking-ui.css` plus `web-components.js`.
  ...
  - `https://cdn.jsdelivr.net/npm/@dataengineeringformachinelearning/viking-ui@9.6.0/dist/viking-ui.css`
  - `https://cdn.jsdelivr.net/npm/@dataengineeringformachinelearning/viking-ui@9.6.0/dist/web-components.js`
