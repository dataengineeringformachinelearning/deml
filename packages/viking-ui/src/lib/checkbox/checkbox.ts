...
@Component({
  ...
  template: `
    <label
      class="viking-checkbox"
      [class.viking-disabled]="disabled() || formDisabled()"
    >
      <span
        class="viking-checkbox-box"
        [class.viking-checked]="checked() || indeterminate()"
      >
        <input
          type="checkbox"
          [checked]="checked()"
  ...
  styles: [
    `
      ...
      .viking-checkbox-box viking-icon,
      .viking-checkbox-box .viking-icon-svg-host,
      .viking-checkbox-box .viking-icon-svg {
        display: block;
        line-height: 0;
        pointer-events: none;
      }
      ...
      .viking-checkbox-description {
        font-size: var(--viking-font-size-sm, 0.875rem);
