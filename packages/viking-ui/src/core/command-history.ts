/**
 * Undo/redo stack for reversible client actions (FORJD ADR-0019).
 * Dual-adapter: keep API aligned with forjd-ui core/a11y/command-history.
 *
...
export function getDefaultCommandHistory(
  options?: CreateCommandHistoryOptions,
): CommandHistory {
  if (!defaultHistory) {
