/**
 * Suite keyboard shortcut registry + helpers (FORJD ADR-0023).
 * Dual-adapter: keep API aligned with forjd-ui core/a11y/keyboard-shortcuts.
 *
...
export function suiteDefaultShortcuts(): readonly SuiteShortcut[] {
  return [
    ...
    },
    {
      ...
      label: "Undo",
      group: "Editing",
      description: "Reversible client actions only (FORJD ADR-0019).",
    },
    {
      id: "redo",
      keys: ["Mod", "Shift", "Z"],
...
export function createShortcutRegistry(
  options?: CreateShortcutRegistryOptions,
): ShortcutRegistry {
