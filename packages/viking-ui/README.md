...
Publish target: **`@dataengineeringformachinelearning/viking-ui@9.3.1`**
...
<html lang="en" data-theme="dark">
  <head>
    ...
    ></script>
    <script
      src="https://cdn.jsdelivr.net/npm/@dataengineeringformachinelearning/viking-ui@9.3.1/dist/widget.js"
      async
      defer
