...
Publish target: **`@dataengineeringformachinelearning/viking-ui@9.1.0`**
...
<html lang="en" data-theme="dark">
  <head>
    ...
    ></script>
    <script
      src="https://cdn.jsdelivr.net/npm/@dataengineeringformachinelearning/viking-ui@9.1.0/dist/widget.js"
      async
      defer
