...
Publish target: **`@dataengineeringformachinelearning/viking-ui@4.9.0`**
...
<link
  rel="stylesheet"
  href="https://cdn.jsdelivr.net/npm/@dataengineeringformachinelearning/viking-ui@4.9.0/dist/viking-ui.css"
/>
<script
  type="module"
  src="https://cdn.jsdelivr.net/npm/@dataengineeringformachinelearning/viking-ui@4.9.0/dist/web-components.js"
></script>
```
...
```html
<script
  src="https://cdn.jsdelivr.net/npm/@dataengineeringformachinelearning/viking-ui@4.9.0/dist/widget.js"
  async
  defer
  data-page-id="platform-status"
  data-backend-url="https://api.example.com"
