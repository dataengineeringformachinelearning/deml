...
- **Observability, Security & CMS**: [Sentry](https://sentry.io), [Semgrep](https://semgrep.dev), [Renovate](https://github.com/renovatebot/renovate), [FOSSA](https://fossa.com), [Checkov](https://www.checkov.io), [Trivy](https://trivy.dev), [Socket.dev](https://socket.dev), [Gitleaks](https://github.com/gitleaks/gitleaks), [detect-secrets](https://github.com/Yelp/detect-secrets), [Sanity.io](https://www.sanity.io), [AbuseIPDB](https://www.abuseipdb.com), [ipify](https://www.ipify.org), [IPinfo](https://ipinfo.io), [Google Analytics](https://analytics.google.com), [Microsoft Clarity](https://clarity.microsoft.com), [Cloudflare Web Analytics](https://cloudflare.com), [Resend](https://resend.com)
