...
- **Frontend**: [Astro](https://astro.build/), [Angular](https://angular.dev/), [Prettier](https://prettier.io/), [ESLint](https://eslint.org/), Native Browser APIs, [Firebase Hosting](https://firebase.google.com/products/hosting), [Viking UI](https://fluxui.dev/) (visual pattern inspiration; Livewire/Tailwind component library — re-implemented as the zero-dependency `@deml/viking-ui` Angular kit themed with THEME.md tokens, not used directly), [ng-packagr](https://github.com/ng-packagr/ng-packagr) (Angular Package Format builds for `@deml/viking-ui`), [AnalogJS](https://analogjs.org/) (`vite-plugin-angular` for Vitest component tests), [Vitest](https://vitest.dev/)
