...
- **Frontend**: [Astro](https://astro.build/), [Angular](https://angular.dev/), [Prettier](https://prettier.io/), [ESLint](https://eslint.org/), Native Browser APIs, [Firebase Hosting](https://firebase.google.com/products/hosting), [Flux UI](https://fluxui.dev/) (visual pattern inspiration; Livewire/Tailwind component library — re-implemented as the zero-dependency `@deml/flux-material` Angular kit themed with THEME.md tokens, not used directly), [ng-packagr](https://github.com/ng-packagr/ng-packagr) (Angular Package Format builds for `@deml/flux-material`), [AnalogJS](https://analogjs.org/) (`vite-plugin-angular` for Vitest component tests), [Vitest](https://vitest.dev/)
