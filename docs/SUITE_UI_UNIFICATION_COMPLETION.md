...
Charts, metric-card, status-dashboard, explore-card, uptime-_, whitepaper-cta, kanban, editor, file-upload, property-filter, hud-panel, gauge-_, etc.
...
@Component({
  ...
  template: `<span
    class="suite-spinner fj-spinner"
    role="status"
