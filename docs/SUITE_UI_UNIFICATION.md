...
> **Superseded (2026-08):** Product visual SoT is **deml-ui** (warm ash NFTS). See [THEME.md](../THEME.md) and [DEML_UI.md](./DEML_UI.md). Viking-UI / forjd.co Angular landing are retired; FORJD public host is **backend.forjd.co** only. This document is historical.
